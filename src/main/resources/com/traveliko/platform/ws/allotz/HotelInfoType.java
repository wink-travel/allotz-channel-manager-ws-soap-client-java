...
@XmlType(name = "HotelInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "hotelName",
    "closedSeasons",
    "relativePositions",
    "categoryCodes",
...
public class HotelInfoType {
    ...
    @XmlElement(name = "ClosedSeasons", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected HotelInfoType.ClosedSeasons closedSeasons;
    @XmlElement(name = "RelativePositions", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected HotelInfoType.RelativePositions relativePositions;
    @XmlElement(name = "CategoryCodes", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected CategoryCodesType categoryCodes;
    @XmlElement(name = "Descriptions", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected HotelInfoType.Descriptions descriptions;
    @XmlElement(name = "HotelInfoCodes", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "WeatherInfos", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected HotelInfoType.WeatherInfos weatherInfos;
    @XmlElement(name = "OwnershipManagementInfos", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected HotelInfoType.OwnershipManagementInfos ownershipManagementInfos;
    @XmlElement(name = "Languages", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class ClosedSeasons {
        ...
        @XmlElement(name = "ClosedSeason", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class Descriptions {
        ...
        @XmlElement(name = "Renovation", namespace = "http://www.opentravel.org/OTA/2003/05")
        protected List<HotelInfoType.Descriptions.Renovation> renovation;
        @XmlElement(name = "MultimediaDescriptions", namespace = "http://www.opentravel.org/OTA/2003/05")
        protected HotelInfoType.Descriptions.MultimediaDescriptions multimediaDescriptions;
        @XmlElement(name = "DescriptiveText", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class HotelInfoCodes {
        ...
        @XmlElement(name = "HotelInfoCode", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class Languages {
        ...
        @XmlElement(name = "Language", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class OwnershipManagementInfos {
        ...
        @XmlElement(name = "OwnershipManagementInfo", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class RelativePositions {
        ...
        @XmlElement(name = "RelativePosition", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class Services {
        ...
        public static class Service {
            ...
            @XmlElement(name = "Contact", namespace = "http://www.opentravel.org/OTA/2003/05")
            protected ContactInfoType contact;
            @XmlElement(name = "RelativePosition", namespace = "http://www.opentravel.org/OTA/2003/05")
            protected RelativePositionType relativePosition;
            @XmlElement(name = "OperationSchedules", namespace = "http://www.opentravel.org/OTA/2003/05")
            protected OperationSchedulesPlusChargeType operationSchedules;
            @XmlElement(name = "MultimediaDescriptions", namespace = "http://www.opentravel.org/OTA/2003/05")
            protected MultimediaDescriptionsType multimediaDescriptions;
            @XmlElement(name = "Features", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class WeatherInfos {
        ...
        @XmlElement(name = "WeatherInfo", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
