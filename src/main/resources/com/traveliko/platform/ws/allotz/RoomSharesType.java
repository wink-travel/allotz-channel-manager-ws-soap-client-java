...
@XmlType(name = "RoomSharesType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "roomShare"
})
public class RoomSharesType {

    @XmlElement(name = "RoomShare", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class RoomShare {
        ...
        @XmlElement(name = "GuestRPHs", namespace = "http://www.opentravel.org/OTA/2003/05")
        ...
        public static class GuestRPHs {
            ...
            @XmlElement(name = "GuestRPH", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
