...
@XmlType(name = "VehicleAvailRSCoreType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "vehRentalCore",
    "vehVendorAvails"
})
public class VehicleAvailRSCoreType {
    ...
    @XmlElement(name = "VehVendorAvails", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class VehVendorAvails {
        ...
        @XmlElement(name = "VehVendorAvail", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
