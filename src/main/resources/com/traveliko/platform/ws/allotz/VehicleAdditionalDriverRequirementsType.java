...
@XmlType(name = "VehicleAdditionalDriverRequirementsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "addlDriverInfos"
})
public class VehicleAdditionalDriverRequirementsType {

    @XmlElement(name = "AddlDriverInfos", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class AddlDriverInfos {
        ...
        @XmlElement(name = "AddlDriverInfo", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
