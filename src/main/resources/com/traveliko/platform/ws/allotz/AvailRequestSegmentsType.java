...
@XmlType(name = "AvailRequestSegmentsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "availRequestSegment"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.OTAHotelAvailRQ.AvailRequestSegments.class
})
