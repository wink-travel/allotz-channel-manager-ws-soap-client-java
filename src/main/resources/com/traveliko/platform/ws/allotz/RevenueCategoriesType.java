...
@XmlType(name = "RevenueCategoriesType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "revenueCategory"
})
public class RevenueCategoriesType {

    @XmlElement(name = "RevenueCategory", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
