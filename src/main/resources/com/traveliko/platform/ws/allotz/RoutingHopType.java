...
@XmlType(name = "RoutingHopType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "routingHop"
})
public class RoutingHopType {

    @XmlElement(name = "RoutingHop", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
