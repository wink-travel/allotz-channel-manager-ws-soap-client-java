...
@XmlType(name = "TotalType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "taxes"
})
@XmlSeeAlso({
    DiscountType.class,
    com.traveliko.platform.ws.allotz.RateUploadType.BaseByGuestAmts.BaseByGuestAmt.class
})
