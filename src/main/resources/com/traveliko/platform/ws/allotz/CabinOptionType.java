...
@XmlType(name = "CabinOptionType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "cabinConfiguration",
    "measurementInfo",
    "remark"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.SailingCategoryInfoType.SelectedCategory.SelectedCabin.class
})
public class CabinOptionType {

    @XmlElement(name = "CabinConfiguration", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<CabinOptionType.CabinConfiguration> cabinConfiguration;
    @XmlElement(name = "MeasurementInfo", namespace = "http://www.opentravel.org/OTA/2003/05")
