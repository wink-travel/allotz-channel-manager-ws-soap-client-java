...
@XmlType(name = "SpecialReqDetailsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "seatRequests",
...
public class SpecialReqDetailsType {
    ...
    @XmlElement(name = "SeatRequests", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected SpecialReqDetailsType.SeatRequests seatRequests;
    @XmlElement(name = "SpecialServiceRequests", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected SpecialReqDetailsType.SpecialServiceRequests specialServiceRequests;
    @XmlElement(name = "OtherServiceInformations", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "SpecialRemarks", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class OtherServiceInformations {
        ...
        @XmlElement(name = "OtherServiceInformation", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class SeatRequests {
        ...
        @XmlElement(name = "SeatRequest", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class SpecialRemarks {
        ...
        @XmlElement(name = "SpecialRemark", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
            ...
            extends SpecialRemarkType
        {
            ...
            @XmlElement(name = "FlightLeg", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class SpecialServiceRequests {
        ...
        @XmlElement(name = "SpecialServiceRequest", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
