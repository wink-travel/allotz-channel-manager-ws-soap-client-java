...
@XmlType(name = "TaxType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "taxDescription"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.PoliciesType.Policy.TaxPolicies.TaxPolicy.class
})
public class TaxType {

    @XmlElement(name = "TaxDescription", namespace = "http://www.opentravel.org/OTA/2003/05")
