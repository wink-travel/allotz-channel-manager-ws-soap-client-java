...
@XmlType(name = "RequiredPaymentsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "guaranteePayment"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.PoliciesType.Policy.GuaranteePaymentPolicy.class
})
