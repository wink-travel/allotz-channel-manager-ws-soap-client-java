...
@XmlType(name = "ExtrasInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "criteria",
    "periods",
    ...
    extends ExtrasCoreType
{
    ...
    @XmlElement(name = "AdditionalInfoPrompt", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "ExtraLocationInfo", namespace = "http://www.opentravel.org/OTA/2003/05")
