...
@XmlType(name = "HotelAdditionalChargesType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "additionalCharge"
})
public class HotelAdditionalChargesType {

    @XmlElement(name = "AdditionalCharge", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class AdditionalCharge {
        ...
        @XmlElement(name = "Amount", namespace = "http://www.opentravel.org/OTA/2003/05")
