...
@XmlType(name = "ContactInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "names",
    "addresses",
    "phones",
    "emails",
...
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.HotelInfoType.OwnershipManagementInfos.OwnershipManagementInfo.class,
    ContactInfoRootType.class,
    com.traveliko.platform.ws.allotz.AreaInfoType.Attractions.Attraction.Contact.class
})
public class ContactInfoType {

    @XmlElement(name = "Names", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected ContactsType names;
    @XmlElement(name = "Addresses", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "Emails", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected EmailsType emails;
    @XmlElement(name = "URLs", namespace = "http://www.opentravel.org/OTA/2003/05")
