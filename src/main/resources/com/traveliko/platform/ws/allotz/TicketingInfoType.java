...
@XmlType(name = "TicketingInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "ticketAdvisory",
    "ticketingVendor",
    "pricingSystem",
    "totalFare"
...
public class TicketingInfoType {
    ...
    @XmlElement(name = "TicketAdvisory", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<TicketingInfoType.TicketAdvisory> ticketAdvisory;
    @XmlElement(name = "TicketingVendor", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected TicketingInfoType.TicketingVendor ticketingVendor;
    @XmlElement(name = "PricingSystem", namespace = "http://www.opentravel.org/OTA/2003/05")
