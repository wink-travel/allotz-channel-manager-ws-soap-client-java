...
@XmlType(name = "VehicleSegmentAdditionalInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "paymentRules",
    "rentalPaymentAmount",
    "pricedCoverages",
    "pricedOffLocService",
...
public class VehicleSegmentAdditionalInfoType {
    ...
    @XmlElement(name = "RentalPaymentAmount", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "PricedOffLocService", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "LocationDetails", namespace = "http://www.opentravel.org/OTA/2003/05")
