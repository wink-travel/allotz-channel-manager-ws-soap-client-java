...
@XmlType(name = "CruiseGuestInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "reservationID",
    "guestDetails",
    "linkedBookings",
    "paymentOptions",
...
public class CruiseGuestInfoType {
    ...
    @XmlElement(name = "ReservationID", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<ReservationIDType> reservationID;
    @XmlElement(name = "GuestDetails", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    protected CruiseGuestInfoType.GuestDetails guestDetails;
    @XmlElement(name = "LinkedBookings", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected CruiseGuestInfoType.LinkedBookings linkedBookings;
    @XmlElement(name = "PaymentOptions", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected CruiseGuestInfoType.PaymentOptions paymentOptions;
    @XmlElement(name = "CancellationPenalty", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class GuestDetails {
        ...
        @XmlElement(name = "GuestDetail", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class LinkedBookings {
        ...
        @XmlElement(name = "LinkedBooking", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class PaymentOptions {
        ...
        @XmlElement(name = "PaymentOption", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
