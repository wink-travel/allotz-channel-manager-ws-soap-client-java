...
@XmlType(name = "ParagraphType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "textOrImageOrURL"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.InvBlockType.BlockDescriptions.BlockDescription.class,
    com.traveliko.platform.ws.allotz.ProfileType.Comments.Comment.class,
    DescriptionType.class,
    com.traveliko.platform.ws.allotz.SpecialRequestType.SpecialRequest.class,
    com.traveliko.platform.ws.allotz.CommentType.Comment.class,
    com.traveliko.platform.ws.allotz.AffiliationInfoType.LoyalPrograms.LoyalProgram.ProgramDescription.class,
    com.traveliko.platform.ws.allotz.AffiliationInfoType.LoyalPrograms.LoyalProgram.ProgramRestriction.class
})
