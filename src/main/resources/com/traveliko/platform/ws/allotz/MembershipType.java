...
@XmlType(name = "MembershipType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "membership"
})
public class MembershipType {

    @XmlElement(name = "Membership", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
