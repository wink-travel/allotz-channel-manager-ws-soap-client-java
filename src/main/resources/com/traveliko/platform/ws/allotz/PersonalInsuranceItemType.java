...
@XmlType(name = "PersonalInsuranceItemType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "customerCounts"
})
public class PersonalInsuranceItemType {

    @XmlElement(name = "CustomerCounts", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
