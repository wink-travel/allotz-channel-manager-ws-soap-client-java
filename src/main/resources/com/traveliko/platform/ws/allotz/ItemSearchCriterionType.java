...
@XmlType(name = "ItemSearchCriterionType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "position",
    "address",
    "telephone",
    "refPoint",
...
public class ItemSearchCriterionType {
    ...
    @XmlElement(name = "RefPoint", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<ItemSearchCriterionType.RefPoint> refPoint;
    @XmlElement(name = "CodeRef", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "Radius", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected ItemSearchCriterionType.Radius radius;
    @XmlElement(name = "MapArea", namespace = "http://www.opentravel.org/OTA/2003/05")
