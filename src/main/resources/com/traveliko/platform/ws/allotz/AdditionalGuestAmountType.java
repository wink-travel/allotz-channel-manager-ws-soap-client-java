...
@XmlType(name = "AdditionalGuestAmountType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "amount",
    "addlGuestAmtDescription"
})
public class AdditionalGuestAmountType {

    @XmlElement(name = "Amount", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
