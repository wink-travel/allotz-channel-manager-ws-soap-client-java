...
@XmlType(name = "VideoDescriptionType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "videoFormat"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.VideoItemsType.VideoItem.class
})
public class VideoDescriptionType {

    @XmlElement(name = "VideoFormat", namespace = "http://www.opentravel.org/OTA/2003/05")
