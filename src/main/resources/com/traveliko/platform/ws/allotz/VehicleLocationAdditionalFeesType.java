...
@XmlType(name = "VehicleLocationAdditionalFeesType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "taxes",
    "fees",
    "surcharges",
...
public class VehicleLocationAdditionalFeesType {
    ...
    @XmlElement(name = "Surcharges", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected VehicleLocationAdditionalFeesType.Surcharges surcharges;
    @XmlElement(name = "MiscellaneousCharges", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class MiscellaneousCharges {
        ...
        @XmlElement(name = "MiscellaneousCharge", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class Surcharges {
        ...
        @XmlElement(name = "Surcharge", namespace = "http://www.opentravel.org/OTA/2003/05")
