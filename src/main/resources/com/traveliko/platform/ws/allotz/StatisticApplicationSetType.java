...
@XmlType(name = "StatisticApplicationSetType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "statisticCodes",
...
public class StatisticApplicationSetType {
    ...
    @XmlElement(name = "StatisticCodes", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected StatisticApplicationSetType.StatisticCodes statisticCodes;
    @XmlElement(name = "RevenueCategorySummaries", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected StatisticApplicationSetType.RevenueCategorySummaries revenueCategorySummaries;
    @XmlElement(name = "CountCategorySummaries", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected StatisticApplicationSetType.CountCategorySummaries countCategorySummaries;
    @XmlElement(name = "ReportSummaries", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class CountCategorySummaries {
        ...
        @XmlElement(name = "CountCategorySummary", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class ReportSummaries {
        ...
        @XmlElement(name = "ReportSummary", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class RevenueCategorySummaries {
        ...
        @XmlElement(name = "RevenueCategorySummary", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class StatisticCodes {
        ...
        @XmlElement(name = "StatisticCode", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
