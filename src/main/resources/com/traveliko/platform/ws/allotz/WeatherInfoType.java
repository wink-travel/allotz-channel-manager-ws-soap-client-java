...
@XmlType(name = "WeatherInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "precipitation",
    "temperature"
})
public class WeatherInfoType {

    @XmlElement(name = "Precipitation", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<WeatherInfoType.Precipitation> precipitation;
    @XmlElement(name = "Temperature", namespace = "http://www.opentravel.org/OTA/2003/05")
