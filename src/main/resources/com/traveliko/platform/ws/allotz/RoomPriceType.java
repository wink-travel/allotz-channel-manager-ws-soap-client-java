...
@XmlType(name = "RoomPriceType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "guestCounts",
    "itemPrice",
    "profilePrice"
})
public class RoomPriceType {
    ...
    @XmlElement(name = "ItemPrice", namespace = "http://www.opentravel.org/OTA/2003/05")
