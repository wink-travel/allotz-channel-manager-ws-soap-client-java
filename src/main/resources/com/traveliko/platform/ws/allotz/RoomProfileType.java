...
@XmlType(name = "RoomProfileType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "passengerRPHs"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.ItineraryItemResponseType.Accommodation.RoomProfiles.RoomProfile.class
})
