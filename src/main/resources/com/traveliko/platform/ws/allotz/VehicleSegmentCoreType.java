...
@XmlType(name = "VehicleSegmentCoreType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "confID",
    "vendor",
    "vehRentalCore",
    "vehicle",
...
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.VehicleReservationType.VehSegmentCore.class
})
