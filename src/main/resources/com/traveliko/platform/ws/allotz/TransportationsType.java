...
@XmlType(name = "TransportationsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "transportations"
})
@XmlSeeAlso({
...
public class TransportationsType {
    ...
    @XmlElement(name = "Transportations", namespace = "http://www.opentravel.org/OTA/2003/05")
