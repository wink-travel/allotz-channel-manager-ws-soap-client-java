...
@XmlType(name = "RatePlanCandidatesType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "ratePlanCandidate"
})
public class RatePlanCandidatesType {
    ...
    public static class RatePlanCandidate {
        ...
        @XmlElement(name = "HotelRefs", namespace = "http://www.opentravel.org/OTA/2003/05")
        ...
        @XmlElement(name = "ArrivalPolicy", namespace = "http://www.opentravel.org/OTA/2003/05")
        protected RatePlanCandidatesType.RatePlanCandidate.ArrivalPolicy arrivalPolicy;
        @XmlElement(name = "RatePlanCommission", namespace = "http://www.opentravel.org/OTA/2003/05")
