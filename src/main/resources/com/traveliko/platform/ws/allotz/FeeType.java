...
@XmlType(name = "FeeType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "taxes",
    "description"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.PoliciesType.Policy.CommissionPolicy.class
})
