...
@XmlType(name = "PreferencesType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "prefCollection"
})
public class PreferencesType {

    @XmlElement(name = "PrefCollection", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class PrefCollection {
        ...
        @XmlElement(name = "CommonPref", namespace = "http://www.opentravel.org/OTA/2003/05")
        protected List<CommonPrefType> commonPref;
        @XmlElement(name = "VehicleRentalPref", namespace = "http://www.opentravel.org/OTA/2003/05")
        protected List<VehicleProfileRentalPrefType> vehicleRentalPref;
        @XmlElement(name = "AirlinePref", namespace = "http://www.opentravel.org/OTA/2003/05")
        protected List<AirlinePrefType> airlinePref;
        @XmlElement(name = "HotelPref", namespace = "http://www.opentravel.org/OTA/2003/05")
        protected List<HotelPrefType> hotelPref;
        @XmlElement(name = "OtherSrvcPref", namespace = "http://www.opentravel.org/OTA/2003/05")
