...
@XmlType(name = "BankAcctType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "bankAcctName"
})
public class BankAcctType {

    @XmlElement(name = "BankAcctName", namespace = "http://www.opentravel.org/OTA/2003/05")
