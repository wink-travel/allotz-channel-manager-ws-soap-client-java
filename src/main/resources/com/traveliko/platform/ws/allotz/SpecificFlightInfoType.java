...
@XmlType(name = "SpecificFlightInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "flightNumber",
    "airline",
    "bookingClassPref"
})
public class SpecificFlightInfoType {
    ...
    @XmlElement(name = "FlightNumber", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected String flightNumber;
    @XmlElement(name = "Airline", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected CompanyNameType airline;
    @XmlElement(name = "BookingClassPref", namespace = "http://www.opentravel.org/OTA/2003/05")
