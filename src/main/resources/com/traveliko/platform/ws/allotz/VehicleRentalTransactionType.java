...
@XmlType(name = "VehicleRentalTransactionType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "pickUpReturnDetails",
    "vehicle",
    "rentalRate",
    "pricedEquips",
...
public class VehicleRentalTransactionType {
    ...
    @XmlElement(name = "PickUpReturnDetails", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "RentalRate", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected VehicleRentalRateType rentalRate;
    @XmlElement(name = "PricedEquips", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "ConfID", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected UniqueIDType confID;
    @XmlElement(name = "ContractID", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class PricedEquips {
        ...
        @XmlElement(name = "PricedEquip", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
        ...
        extends VehicleType
    {
        ...
        @XmlElement(name = "VehRentalDetails", namespace = "http://www.opentravel.org/OTA/2003/05")
