...
@XmlType(name = "VehicleVendorAvailabilityType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "vendor",
    "vehAvails",
    "info"
})
public class VehicleVendorAvailabilityType {
    ...
    @XmlElement(name = "VehAvails", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class VehAvails {
        ...
        @XmlElement(name = "VehAvail", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
        ...
        public static class VehAvail {
            ...
            @XmlElement(name = "VehAvailCore", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
            protected VehicleAvailCoreType vehAvailCore;
            @XmlElement(name = "VehAvailInfo", namespace = "http://www.opentravel.org/OTA/2003/05")
