...
@XmlType(name = "RestaurantType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
...
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.RestaurantsType.Restaurant.class
})
public class RestaurantType {
    ...
    @XmlElement(name = "InfoCodes", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected RestaurantType.InfoCodes infoCodes;
    @XmlElement(name = "CuisineCodes", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class CuisineCodes {
        ...
        @XmlElement(name = "CuisineCode", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class InfoCodes {
        ...
        @XmlElement(name = "InfoCode", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
