...
@XmlType(name = "RevenueDetailType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "folioIDs"
})
public class RevenueDetailType {

    @XmlElement(name = "FolioIDs", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
