...
@XmlType(name = "ContactPersonType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "personName",
    "telephone",
    "address",
    "email",
...
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.CruiseGuestDetailType.ContactInfo.class,
    com.traveliko.platform.ws.allotz.HotelRoomListType.Guests.Guest.class,
    com.traveliko.platform.ws.allotz.HotelRoomListType.MasterContact.class,
    com.traveliko.platform.ws.allotz.RecipientInfosType.RecipientInfo.class
})
