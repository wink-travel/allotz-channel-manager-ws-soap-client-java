...
@XmlType(name = "FormattedTextType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "subSection"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.VehicleAgeRequirementsType.Age.AgeInfos.AgeInfo.class,
    VendorMessageType.class,
    VehicleLocationInformationType.class,
    com.traveliko.platform.ws.allotz.VehicleLocationVehiclesType.VehicleInfos.VehicleInfo.class,
    com.traveliko.platform.ws.allotz.VehicleAdditionalDriverRequirementsType.AddlDriverInfos.AddlDriverInfo.class,
    com.traveliko.platform.ws.allotz.VehicleLocationAdditionalDetailsType.Shuttle.ShuttleInfos.ShuttleInfo.class
})
public class FormattedTextType {

    @XmlElement(name = "SubSection", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
