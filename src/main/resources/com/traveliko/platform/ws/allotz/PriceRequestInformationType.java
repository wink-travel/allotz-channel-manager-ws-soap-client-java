...
@XmlType(name = "PriceRequestInformationType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "negotiatedFareCode",
    "rebookOption"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.TravelerInfoSummaryType.PriceRequestInformation.class
})
public class PriceRequestInformationType {

    @XmlElement(name = "NegotiatedFareCode", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<PriceRequestInformationType.NegotiatedFareCode> negotiatedFareCode;
    @XmlElement(name = "RebookOption", namespace = "http://www.opentravel.org/OTA/2003/05")
