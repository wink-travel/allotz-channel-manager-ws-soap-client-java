...
@XmlType(name = "OtherSrvcPrefType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "otherSrvcName",
    "vendorPref",
    "loyaltyPref",
    "paymentFormPref",
...
public class OtherSrvcPrefType {
    ...
    @XmlElement(name = "OtherSrvcName", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
