...
@XmlType(name = "VehicleRentalCoreType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "pickUpLocation",
    "returnLocation"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.VehicleRentalTransactionType.PickUpReturnDetails.class,
    com.traveliko.platform.ws.allotz.ItineraryItemRequestType.RentalCar.class,
    com.traveliko.platform.ws.allotz.ItineraryItemResponseType.RentalCar.class
})
