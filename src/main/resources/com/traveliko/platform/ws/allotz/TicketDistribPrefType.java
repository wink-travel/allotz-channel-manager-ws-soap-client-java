...
@XmlType(name = "TicketDistribPrefType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "value"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.AirSearchPrefsType.TicketDistribPref.class
})
