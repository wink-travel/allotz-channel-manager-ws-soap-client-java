...
@XmlType(name = "CabinAvailabilityType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "meal",
    "baggageAllowance"
})
@XmlSeeAlso({
...
public class CabinAvailabilityType {
    ...
    @XmlElement(name = "Meal", namespace = "http://www.opentravel.org/OTA/2003/05")
