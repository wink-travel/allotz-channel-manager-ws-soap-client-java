...
@XmlType(name = "RelatedTravelerType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "uniqueID",
    "personName"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.CruiseGuestInfoType.LinkedBookings.LinkedBooking.class,
    com.traveliko.platform.ws.allotz.CruiseGuestDetailType.LinkedTraveler.class
})
