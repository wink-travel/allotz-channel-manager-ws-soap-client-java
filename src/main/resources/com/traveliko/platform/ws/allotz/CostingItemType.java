...
@XmlType(name = "CostingItemType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "unitCost",
    "extendedCost",
    "commission"
})
public class CostingItemType {
    ...
    @XmlElement(name = "UnitCost", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    protected CostingItemType.UnitCost unitCost;
    @XmlElement(name = "ExtendedCost", namespace = "http://www.opentravel.org/OTA/2003/05")
