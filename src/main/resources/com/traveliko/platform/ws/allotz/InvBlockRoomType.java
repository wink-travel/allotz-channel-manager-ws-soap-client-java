...
@XmlType(name = "InvBlockRoomType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "roomTypeAllocations",
    "ratePlans",
    "daysOfWeeks"
})
public class InvBlockRoomType {
    ...
    @XmlElement(name = "RoomTypeAllocations", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "DaysOfWeeks", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class DaysOfWeeks {
        ...
        @XmlElement(name = "DaysOfWeek", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class RatePlans {
            ...
            extends RateUploadType
        {
            ...
            @XmlElement(name = "MarketCode", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class RoomTypeAllocations {
        ...
        @XmlElement(name = "RoomTypeAllocation", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
