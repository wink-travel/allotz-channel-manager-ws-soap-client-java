...
@XmlType(name = "RoomStayType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "roomTypes",
    "ratePlans",
    "roomRates",
    "guestCounts",
...
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.OTAHotelAvailRS.RoomStays.RoomStay.class,
    com.traveliko.platform.ws.allotz.RoomStaysType.RoomStay.class,
    com.traveliko.platform.ws.allotz.HotelRoomListType.RoomStays.RoomStay.class
})
public class RoomStayType {
    ...
    @XmlElement(name = "DepositPayments", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "Discount", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "MapURL", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class RoomRates {
            ...
            extends RoomRateType
        {
            ...
            @XmlElement(name = "AdvanceBookingRestriction", namespace = "http://www.opentravel.org/OTA/2003/05")
            protected RoomStayType.RoomRates.RoomRate.AdvanceBookingRestriction advanceBookingRestriction;
            @XmlElement(name = "Restrictions", namespace = "http://www.opentravel.org/OTA/2003/05")
            ...
            public static class Restrictions {
                ...
                public static class Restriction {
                    ...
                    @XmlElement(name = "DOW_Restrictions", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
