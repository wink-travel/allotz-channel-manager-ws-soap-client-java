...
@XmlType(name = "CoverageType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "details"
})
public class CoverageType {

    @XmlElement(name = "Details", namespace = "http://www.opentravel.org/OTA/2003/05")
