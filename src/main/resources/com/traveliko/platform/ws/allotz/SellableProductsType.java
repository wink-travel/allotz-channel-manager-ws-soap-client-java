...
@XmlType(name = "SellableProductsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "sellableProduct"
})
public class SellableProductsType {

    @XmlElement(name = "SellableProduct", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class SellableProduct {
        ...
        @XmlElement(name = "InventoryBlock", namespace = "http://www.opentravel.org/OTA/2003/05")
        ...
        public static class DestinationSystemCodes {
            ...
            @XmlElement(name = "DestinationSystemCode", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
