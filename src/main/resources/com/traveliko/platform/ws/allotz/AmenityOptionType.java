...
@XmlType(name = "AmenityOptionType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "originator",
    "message"
})
public class AmenityOptionType {

    @XmlElement(name = "Originator", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected PersonNameType originator;
    @XmlElement(name = "Message", namespace = "http://www.opentravel.org/OTA/2003/05")
