...
@XmlType(name = "SailingCategoryInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "selectedCategory"
})
    ...
    extends SailingInfoType
{
    ...
    @XmlElement(name = "SelectedCategory", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class SelectedCategory {
        ...
        @XmlElement(name = "CabinAttributes", namespace = "http://www.opentravel.org/OTA/2003/05")
        protected SailingCategoryInfoType.SelectedCategory.CabinAttributes cabinAttributes;
        @XmlElement(name = "SelectedCabin", namespace = "http://www.opentravel.org/OTA/2003/05")
        ...
        public static class CabinAttributes {
            ...
            @XmlElement(name = "CabinAttribute", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
