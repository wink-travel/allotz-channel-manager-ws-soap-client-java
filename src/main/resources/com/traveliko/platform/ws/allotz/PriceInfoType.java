...
@XmlType(name = "PriceInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "priceDescription"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.CategoryOptionType.PriceInfos.PriceInfo.class
})
public class PriceInfoType {

    @XmlElement(name = "PriceDescription", namespace = "http://www.opentravel.org/OTA/2003/05")
