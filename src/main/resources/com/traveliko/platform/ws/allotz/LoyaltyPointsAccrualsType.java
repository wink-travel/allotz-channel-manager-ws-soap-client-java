...
@XmlType(name = "LoyaltyPointsAccrualsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "selectedLoyalty"
})
public class LoyaltyPointsAccrualsType {

    @XmlElement(name = "SelectedLoyalty", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
