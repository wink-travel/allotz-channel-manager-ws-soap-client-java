...
@XmlType(name = "AgreementsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "certification",
    "allianceConsortium",
    "commissionInfo",
    "profileSecurity",
...
public class AgreementsType {
    ...
    @XmlElement(name = "Certification", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<CertificationType> certification;
    @XmlElement(name = "AllianceConsortium", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<AllianceConsortiumType> allianceConsortium;
    @XmlElement(name = "CommissionInfo", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<CommissionInfoType> commissionInfo;
    @XmlElement(name = "ProfileSecurity", namespace = "http://www.opentravel.org/OTA/2003/05")
