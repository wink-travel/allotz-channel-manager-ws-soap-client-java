...
@XmlType(name = "VehicleResRSCoreType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "vehReservation",
    "tpaExtensions"
})
public class VehicleResRSCoreType {

    @XmlElement(name = "VehReservation", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
