...
@XmlType(name = "RoomStaysType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "roomStay"
})
public class RoomStaysType {
        ...
        extends RoomStayType
    {
        ...
        @XmlElement(name = "BookingRules", namespace = "http://www.opentravel.org/OTA/2003/05")
