...
@XmlType(name = "PersonNameType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "namePrefix",
    "givenName",
    "middleName",
    "surnamePrefix",
...
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.VerificationType.PersonName.class,
    com.traveliko.platform.ws.allotz.TravelClubType.ClubMemberName.class,
    com.traveliko.platform.ws.allotz.ContactsType.Name.class,
    com.traveliko.platform.ws.allotz.OrganizationType.OrgMemberName.class
})
public class PersonNameType {
    ...
    @XmlElement(name = "NameSuffix", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<String> nameSuffix;
    @XmlElement(name = "NameTitle", namespace = "http://www.opentravel.org/OTA/2003/05")
