...
@XmlType(name = "AffiliationInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "distribSystems",
    "brands",
    "loyalPrograms",
    "awards",
...
public class AffiliationInfoType {
    ...
    @XmlElement(name = "Brands", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected AffiliationInfoType.Brands brands;
    @XmlElement(name = "LoyalPrograms", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "PartnerInfos", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class Brands {
        ...
        @XmlElement(name = "Brand", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class DistribSystems {
        ...
        @XmlElement(name = "DistribSystem", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class LoyalPrograms {
        ...
        @XmlElement(name = "LoyalProgram", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
        ...
        public static class LoyalProgram {
            ...
            @XmlElement(name = "ProgramDescription", namespace = "http://www.opentravel.org/OTA/2003/05")
            protected List<AffiliationInfoType.LoyalPrograms.LoyalProgram.ProgramDescription> programDescription;
            @XmlElement(name = "ProgramRestriction", namespace = "http://www.opentravel.org/OTA/2003/05")
            protected AffiliationInfoType.LoyalPrograms.LoyalProgram.ProgramRestriction programRestriction;
            @XmlElement(name = "BlackoutDates", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class PartnerInfos {
        ...
        @XmlElement(name = "PartnerInfo", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
