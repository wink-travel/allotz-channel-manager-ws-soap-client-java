...
@XmlType(name = "AffiliationsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "organization",
    "employer",
    "travelArranger",
    "travelClub",
...
public class AffiliationsType {
    ...
    @XmlElement(name = "Organization", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<OrganizationType> organization;
    @XmlElement(name = "Employer", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "TravelClub", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<TravelClubType> travelClub;
    @XmlElement(name = "Insurance", namespace = "http://www.opentravel.org/OTA/2003/05")
