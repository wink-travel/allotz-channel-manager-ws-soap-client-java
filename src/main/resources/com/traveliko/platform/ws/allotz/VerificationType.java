...
@XmlType(name = "VerificationType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "personName",
    "email",
    "telephoneInfo",
    "paymentCard",
...
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.HotelResModifyType.HotelResModify.Verification.class
})
public class VerificationType {
    ...
    @XmlElement(name = "TelephoneInfo", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "AddressInfo", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "ReservationTimeSpan", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected VerificationType.ReservationTimeSpan reservationTimeSpan;
    @XmlElement(name = "AssociatedQuantity", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<VerificationType.AssociatedQuantity> associatedQuantity;
    @XmlElement(name = "StartLocation", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected VerificationType.StartLocation startLocation;
    @XmlElement(name = "EndLocation", namespace = "http://www.opentravel.org/OTA/2003/05")
