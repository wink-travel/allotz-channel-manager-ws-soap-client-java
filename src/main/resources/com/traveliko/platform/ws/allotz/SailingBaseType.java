...
@XmlType(name = "SailingBaseType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "cruiseLine",
    "region",
    "departurePort",
    "arrivalPort"
...
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.SailingInfoType.SelectedSailing.class
})
public class SailingBaseType {

    @XmlElement(name = "CruiseLine", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    protected SailingBaseType.CruiseLine cruiseLine;
    @XmlElement(name = "Region", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected SailingBaseType.Region region;
    @XmlElement(name = "DeparturePort", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected SailingBaseType.DeparturePort departurePort;
    @XmlElement(name = "ArrivalPort", namespace = "http://www.opentravel.org/OTA/2003/05")
