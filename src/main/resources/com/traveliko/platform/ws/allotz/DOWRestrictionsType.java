...
@XmlType(name = "DOW_RestrictionsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "availableDaysOfWeek",
    "arrivalDaysOfWeek",
    "departureDaysOfWeek",
    "requiredDaysOfWeek"
...
public class DOWRestrictionsType {
    ...
    @XmlElement(name = "AvailableDaysOfWeek", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected DOWRestrictionsType.AvailableDaysOfWeek availableDaysOfWeek;
    @XmlElement(name = "ArrivalDaysOfWeek", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected DOWRestrictionsType.ArrivalDaysOfWeek arrivalDaysOfWeek;
    @XmlElement(name = "DepartureDaysOfWeek", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected DOWRestrictionsType.DepartureDaysOfWeek departureDaysOfWeek;
    @XmlElement(name = "RequiredDaysOfWeek", namespace = "http://www.opentravel.org/OTA/2003/05")
