...
@XmlType(name = "InsuranceType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "insuredName",
    "insuranceCompany",
    "underwriter"
})
public class InsuranceType {
    ...
    @XmlElement(name = "InsuredName", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected PersonNameType insuredName;
    @XmlElement(name = "InsuranceCompany", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected CompanyNameType insuranceCompany;
    @XmlElement(name = "Underwriter", namespace = "http://www.opentravel.org/OTA/2003/05")
