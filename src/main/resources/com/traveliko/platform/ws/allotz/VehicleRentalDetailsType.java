...
@XmlType(name = "VehicleRentalDetailsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "fuelLevelDetails",
    "odometerReading",
    "conditionReport"
})
public class VehicleRentalDetailsType {
    ...
    @XmlElement(name = "ConditionReport", namespace = "http://www.opentravel.org/OTA/2003/05")
