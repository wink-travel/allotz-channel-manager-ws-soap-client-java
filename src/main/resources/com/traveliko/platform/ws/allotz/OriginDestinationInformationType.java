...
@XmlType(name = "OriginDestinationInformationType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "originLocation",
    "destinationLocation",
    "connectionLocations"
})
    ...
    extends TravelDateTimeType
{
    ...
    @XmlElement(name = "ConnectionLocations", namespace = "http://www.opentravel.org/OTA/2003/05")
