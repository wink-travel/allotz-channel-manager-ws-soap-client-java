...
@XmlType(name = "ContactsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "name"
})
public class ContactsType {

    @XmlElement(name = "Name", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
        ...
        extends PersonNameType
    {
        ...
        @XmlElement(name = "JobTitle", namespace = "http://www.opentravel.org/OTA/2003/05")
