...
@XmlType(name = "ItineraryItemResponseType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "accommodation",
    "flight",
    "rentalCar"
})
public class ItineraryItemResponseType {
    ...
    public static class Accommodation {
        ...
        @XmlElement(name = "Identity", namespace = "http://www.opentravel.org/OTA/2003/05")
        ...
        @XmlElement(name = "RoomProfiles", namespace = "http://www.opentravel.org/OTA/2003/05")
        protected ItineraryItemResponseType.Accommodation.RoomProfiles roomProfiles;
        @XmlElement(name = "MealPlans", namespace = "http://www.opentravel.org/OTA/2003/05")
        ...
        public static class RoomProfiles {
            ...
            @XmlElement(name = "RoomProfile", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
