...
@XmlType(name = "PackageResponseType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "url",
    "companyName",
    "dateRange",
    "itineraryItems",
...
public class PackageResponseType {
    ...
    @XmlElement(name = "ItineraryItems", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected PackageResponseType.ItineraryItems itineraryItems;
    @XmlElement(name = "Extras", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected PackageResponseType.Extras extras;
    @XmlElement(name = "Cautions", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class Cautions {
        ...
        @XmlElement(name = "Caution", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class Extras {
        ...
        @XmlElement(name = "Extra", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class ItineraryItems {
        ...
        @XmlElement(name = "ItineraryItem", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
