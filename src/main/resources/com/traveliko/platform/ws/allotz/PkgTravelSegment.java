...
@XmlType(name = "PkgTravelSegment", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "airSegment"
})
public class PkgTravelSegment {

    @XmlElement(name = "AirSegment", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
