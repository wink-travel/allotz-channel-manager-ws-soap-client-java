...
@XmlType(name = "ResCommonDetailType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "guestCounts",
    "timeSpan",
    "resGuestRPHs",
    "memberships",
...
public class ResCommonDetailType {
    ...
    @XmlElement(name = "Memberships", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "SpecialRequests", namespace = "http://www.opentravel.org/OTA/2003/05")
