...
@XmlType(name = "AccommodationDetailType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "facilityChoices"
})
    ...
    extends AccommodationInfoType
{
    ...
    @XmlElement(name = "FacilityChoices", namespace = "http://www.opentravel.org/OTA/2003/05")
