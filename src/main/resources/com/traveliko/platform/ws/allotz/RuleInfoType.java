...
@XmlType(name = "RuleInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "resTicketingRules",
    "lengthOfStayRules",
    "chargesRules"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.FareInfoType.RuleInfo.class
})
public class RuleInfoType {

    @XmlElement(name = "ResTicketingRules", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected RuleInfoType.ResTicketingRules resTicketingRules;
    @XmlElement(name = "LengthOfStayRules", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected StayRestrictionsType lengthOfStayRules;
    @XmlElement(name = "ChargesRules", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class ChargesRules {
        ...
        @XmlElement(name = "VoluntaryRefunds", namespace = "http://www.opentravel.org/OTA/2003/05")
