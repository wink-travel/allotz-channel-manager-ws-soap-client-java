...
@XmlType(name = "FormattedTextSubSectionType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "paragraph"
})
public class FormattedTextSubSectionType {

    @XmlElement(name = "Paragraph", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
