...
@XmlType(name = "HotelResModifyType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "hotelResModify",
    "routingHops",
    "writtenConfInst"
})
public class HotelResModifyType {
    ...
    @XmlElement(name = "HotelResModify", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
        ...
        extends HotelReservationType
    {
            ...
            extends VerificationType
        {
            ...
            @XmlElement(name = "CurrentStateReservation", namespace = "http://www.opentravel.org/OTA/2003/05")
