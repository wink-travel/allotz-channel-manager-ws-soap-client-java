...
@XmlType(name = "AddressInfoType", namespace = "http://www.opentravel.org/OTA/2003/05")
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.CompanyInfoType.AddressInfo.class,
    com.traveliko.platform.ws.allotz.CustomerType.Address.class,
    com.traveliko.platform.ws.allotz.AddressesType.Address.class,
    com.traveliko.platform.ws.allotz.RequiredPaymentsType.GuaranteePayment.Address.class
})
