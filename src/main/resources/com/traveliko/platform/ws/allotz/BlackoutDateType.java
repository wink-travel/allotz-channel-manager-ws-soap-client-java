...
@XmlType(name = "BlackoutDateType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "blackoutDate"
})
public class BlackoutDateType {

    @XmlElement(name = "BlackoutDate", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
