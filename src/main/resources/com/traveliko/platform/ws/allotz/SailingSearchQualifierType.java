...
@XmlType(name = "SailingSearchQualifierType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "port"
})
    ...
    extends SearchQualifierType
{
    ...
    @XmlElement(name = "Port", namespace = "http://www.opentravel.org/OTA/2003/05")
