...
@XmlType(name = "RoomRateType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "rates",
    "roomRateDescription",
    "features",
    "total",
...
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.RoomStayType.RoomRates.RoomRate.class
})
public class RoomRateType {
    ...
    public static class Features {
        ...
        @XmlElement(name = "Feature", namespace = "http://www.opentravel.org/OTA/2003/05")
