...
@XmlType(name = "HotelReservationType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "pos",
    "uniqueID",
    "roomStays",
    "services",
...
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.HotelResModifyType.HotelResModify.class
})
