...
@XmlType(name = "DocumentHandlingType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "vendorOption"
})
public class DocumentHandlingType {

    @XmlElement(name = "VendorOption", namespace = "http://www.opentravel.org/OTA/2003/05")
