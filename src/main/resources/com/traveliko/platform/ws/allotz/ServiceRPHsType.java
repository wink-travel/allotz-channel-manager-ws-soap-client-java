...
@XmlType(name = "ServiceRPHsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "serviceRPH"
})
public class ServiceRPHsType {

    @XmlElement(name = "ServiceRPH", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
