...
@XmlType(name = "AreaInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "refPoints",
    "attractions",
    "recreations",
    "otherHotels"
...
public class AreaInfoType {
    ...
    @XmlElement(name = "RefPoints", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected AreaInfoType.RefPoints refPoints;
    @XmlElement(name = "Attractions", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected AreaInfoType.Attractions attractions;
    @XmlElement(name = "Recreations", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected AreaInfoType.Recreations recreations;
    @XmlElement(name = "OtherHotels", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class Attractions {
        ...
        @XmlElement(name = "Attraction", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class OtherHotels {
        ...
        @XmlElement(name = "OtherHotel", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
        ...
        public static class OtherHotel {
            ...
            @XmlElement(name = "ContactInfos", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class Recreations {
        ...
        @XmlElement(name = "Recreation", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
        ...
        public static class Recreation {
            ...
            @XmlElement(name = "RecreationDetails", namespace = "http://www.opentravel.org/OTA/2003/05")
            ...
            public static class RecreationDetails {
                ...
                @XmlElement(name = "RecreationDetail", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
