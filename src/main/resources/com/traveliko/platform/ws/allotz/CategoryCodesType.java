...
@XmlType(name = "CategoryCodesType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "locationCategory",
    "segmentCategory",
    "hotelCategory",
    "architecturalStyle",
...
public class CategoryCodesType {
    ...
    @XmlElement(name = "LocationCategory", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<CategoryCodesType.LocationCategory> locationCategory;
    @XmlElement(name = "SegmentCategory", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<CategoryCodesType.SegmentCategory> segmentCategory;
    @XmlElement(name = "HotelCategory", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<CategoryCodesType.HotelCategory> hotelCategory;
    @XmlElement(name = "ArchitecturalStyle", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<CategoryCodesType.ArchitecturalStyle> architecturalStyle;
    @XmlElement(name = "GuestRoomInfo", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class GuestRoomInfo {
        ...
        @XmlElement(name = "RateRanges", namespace = "http://www.opentravel.org/OTA/2003/05")
