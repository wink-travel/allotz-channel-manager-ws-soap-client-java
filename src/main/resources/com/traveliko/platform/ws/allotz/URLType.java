...
@XmlType(name = "URL_Type", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "value"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.URLsType.URL.class,
    com.traveliko.platform.ws.allotz.CustomerType.URL.class
})
