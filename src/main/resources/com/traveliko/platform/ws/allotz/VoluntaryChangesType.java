...
@XmlType(name = "VoluntaryChangesType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "penalty"
})
public class VoluntaryChangesType {

    @XmlElement(name = "Penalty", namespace = "http://www.opentravel.org/OTA/2003/05")
