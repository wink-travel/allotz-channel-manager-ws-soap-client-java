...
@XmlType(name = "OperationSchedulePlusChargeType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "charge"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.OperationSchedulesPlusChargeType.OperationSchedule.class
})
