...
@XmlType(name = "HotelRoomListType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "uniqueID",
    "guests",
    "masterContact",
    "masterAccount",
...
public class HotelRoomListType {
    ...
    @XmlElement(name = "Guests", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected HotelRoomListType.Guests guests;
    @XmlElement(name = "MasterContact", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected HotelRoomListType.MasterContact masterContact;
    @XmlElement(name = "MasterAccount", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "Event", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class Event {
        ...
        @XmlElement(name = "EventContact", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class Guests {
        ...
        @XmlElement(name = "Guest", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
            ...
            extends ContactPersonType
        {
            ...
            @XmlElement(name = "UniqueID", namespace = "http://www.opentravel.org/OTA/2003/05")
            protected UniqueIDType uniqueID;
            @XmlElement(name = "Loyalty", namespace = "http://www.opentravel.org/OTA/2003/05")
            protected List<HotelRoomListType.Guests.Guest.Loyalty> loyalty;
            @XmlElement(name = "GuaranteePayment", namespace = "http://www.opentravel.org/OTA/2003/05")
        ...
        extends ContactPersonType
    {
        ...
        @XmlElement(name = "UniqueIDs", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class RoomStays {
            ...
            extends RoomStayType
        {
            ...
            @XmlElement(name = "RoomShares", namespace = "http://www.opentravel.org/OTA/2003/05")
