...
@XmlType(name = "ProfileType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "accesses",
    "customer",
    "userID",
    "prefCollections",
...
public class ProfileType {
    ...
    public static class Comments {
            ...
            extends ParagraphType
        {
            ...
            @XmlElement(name = "AuthorizedViewer", namespace = "http://www.opentravel.org/OTA/2003/05")
