...
@XmlType(name = "VehicleRentalRateType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "rateDistance",
    "vehicleCharges",
    "rateQualifier",
    "rateRestrictions",
...
public class VehicleRentalRateType {
    ...
    @XmlElement(name = "RateRestrictions", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "PickupReturnRule", namespace = "http://www.opentravel.org/OTA/2003/05")
