...
@XmlType(name = "OrganizationType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "orgMemberName",
    "orgName",
    "relatedOrgName",
    "travelArranger"
...
public class OrganizationType {
    ...
    @XmlElement(name = "OrgMemberName", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected OrganizationType.OrgMemberName orgMemberName;
    @XmlElement(name = "OrgName", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected CompanyNameType orgName;
    @XmlElement(name = "RelatedOrgName", namespace = "http://www.opentravel.org/OTA/2003/05")
