...
@XmlType(name = "HotelSearchCriteriaType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "criterion"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.AvailRequestSegmentsType.AvailRequestSegment.HotelSearchCriteria.class
})
