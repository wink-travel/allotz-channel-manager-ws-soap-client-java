...
@XmlType(name = "ShipInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "ship",
    "shipLength",
    "shipVoltage"
})
public class ShipInfoType {
    ...
    @XmlElement(name = "Ship", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected ShipInfoType.Ship ship;
    @XmlElement(name = "ShipLength", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected ShipInfoType.ShipLength shipLength;
    @XmlElement(name = "ShipVoltage", namespace = "http://www.opentravel.org/OTA/2003/05")
