...
@XmlType(name = "PropertyValueMatchType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "searchValueMatch",
    "amenities",
    "rateRange"
})
    ...
    extends BasicPropertyInfoType
{
    ...
    @XmlElement(name = "SearchValueMatch", namespace = "http://www.opentravel.org/OTA/2003/05")
