...
@XmlType(name = "RecipientInfosType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "recipientInfo"
})
public class RecipientInfosType {

    @XmlElement(name = "RecipientInfo", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
        ...
        extends ContactPersonType
    {
        ...
        @XmlElement(name = "ShippingInfo", namespace = "http://www.opentravel.org/OTA/2003/05")
