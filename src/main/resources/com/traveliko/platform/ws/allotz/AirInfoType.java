...
@XmlType(name = "AirInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "departureCity",
    "arrivalCity",
    "airline"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.CruiseGuestDetailType.AirAccommodations.AirAccommodation.class
})
public class AirInfoType {

    @XmlElement(name = "DepartureCity", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected LocationType departureCity;
    @XmlElement(name = "ArrivalCity", namespace = "http://www.opentravel.org/OTA/2003/05")
