...
@XmlType(name = "OriginDestinationOptionType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "flightSegment"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.AirItineraryType.OriginDestinationOptions.OriginDestinationOption.class
})
public class OriginDestinationOptionType {

    @XmlElement(name = "FlightSegment", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
