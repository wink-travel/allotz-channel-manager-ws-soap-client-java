...
@XmlType(name = "DiscountType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "discountReason"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.AmountType.Discount.class
})
public class DiscountType
    extends TotalType
{

    @XmlElement(name = "DiscountReason", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
