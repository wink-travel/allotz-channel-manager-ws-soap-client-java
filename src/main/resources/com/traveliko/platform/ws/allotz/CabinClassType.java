...
@XmlType(name = "CabinClassType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "airRows"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.SeatMapDetailsType.CabinClass.class
})
public class CabinClassType {

    @XmlElement(name = "AirRows", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class AirRows {
        ...
        @XmlElement(name = "AirRow", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
