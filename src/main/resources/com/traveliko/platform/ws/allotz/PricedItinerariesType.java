...
@XmlType(name = "PricedItinerariesType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "pricedItinerary"
})
public class PricedItinerariesType {

    @XmlElement(name = "PricedItinerary", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
