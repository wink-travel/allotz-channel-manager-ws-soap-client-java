...
@XmlType(name = "RevenueDetailsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "revenueDetail"
})
public class RevenueDetailsType {

    @XmlElement(name = "RevenueDetail", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
