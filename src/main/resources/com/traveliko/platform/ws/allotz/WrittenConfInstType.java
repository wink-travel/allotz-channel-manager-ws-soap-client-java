...
@XmlType(name = "WrittenConfInstType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "supplementalData",
    "email"
})
public class WrittenConfInstType {

    @XmlElement(name = "SupplementalData", namespace = "http://www.opentravel.org/OTA/2003/05")
