...
@XmlType(name = "FulfillmentType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "paymentDetails",
    "deliveryAddress",
    "name",
    "receipt",
...
public class FulfillmentType {
    ...
    @XmlElement(name = "PaymentText", namespace = "http://www.opentravel.org/OTA/2003/05")
