...
@XmlType(name = "GuestRoomType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "quantities",
    "occupancy",
    "room",
    "amenities",
...
public class GuestRoomType {
    ...
    @XmlElement(name = "Quantities", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected GuestRoomType.Quantities quantities;
    @XmlElement(name = "Occupancy", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<GuestRoomType.Occupancy> occupancy;
    @XmlElement(name = "Room", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "RoomLevelFees", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected GuestRoomType.RoomLevelFees roomLevelFees;
    @XmlElement(name = "AdditionalGuestAmount", namespace = "http://www.opentravel.org/OTA/2003/05")
