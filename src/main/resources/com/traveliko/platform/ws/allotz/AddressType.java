...
@XmlType(name = "AddressType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "streetNmbr",
    "bldgRoom",
    "addressLine",
    "cityName",
...
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.OffLocationServiceCoreType.Address.class,
    com.traveliko.platform.ws.allotz.ItemSearchCriterionType.Address.class,
    AddressInfoType.class,
    com.traveliko.platform.ws.allotz.AirTravelerType.Address.class
})
public class AddressType {

    @XmlElement(name = "StreetNmbr", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected AddressType.StreetNmbr streetNmbr;
    @XmlElement(name = "BldgRoom", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "County", namespace = "http://www.opentravel.org/OTA/2003/05")
