...
@XmlType(name = "CompanyInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "companyName",
    "addressInfo",
    "telephoneInfo",
    "email",
...
public class CompanyInfoType {
    ...
    @XmlElement(name = "BusinessLocale", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "TravelArranger", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<TravelArrangerType> travelArranger;
    @XmlElement(name = "LoyaltyProgram", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<LoyaltyProgramType> loyaltyProgram;
    @XmlElement(name = "TripPurpose", namespace = "http://www.opentravel.org/OTA/2003/05")
