...
@XmlType(name = "VehicleReservationType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "customer",
    "vehSegmentCore",
    "vehSegmentInfo"
})
public class VehicleReservationType {
    ...
    @XmlElement(name = "VehSegmentCore", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    protected VehicleReservationType.VehSegmentCore vehSegmentCore;
    @XmlElement(name = "VehSegmentInfo", namespace = "http://www.opentravel.org/OTA/2003/05")
