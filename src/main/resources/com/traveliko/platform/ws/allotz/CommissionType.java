...
@XmlType(name = "CommissionType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "uniqueID",
...
public class CommissionType {
    ...
    @XmlElement(name = "CommissionableAmount", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected CommissionType.CommissionableAmount commissionableAmount;
    @XmlElement(name = "PrepaidAmount", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected CommissionType.PrepaidAmount prepaidAmount;
    @XmlElement(name = "FlatCommission", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected CommissionType.FlatCommission flatCommission;
    @XmlElement(name = "CommissionPayableAmount", namespace = "http://www.opentravel.org/OTA/2003/05")
