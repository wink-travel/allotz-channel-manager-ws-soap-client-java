...
@XmlType(name = "AdjustmentsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "adjustment"
})
public class AdjustmentsType {

    @XmlElement(name = "Adjustment", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
