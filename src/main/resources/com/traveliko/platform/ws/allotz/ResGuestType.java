...
@XmlType(name = "ResGuestType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "profiles",
    "specialRequests",
    "comments",
    "serviceRPHs",
...
public class ResGuestType {
    ...
    @XmlElement(name = "ProfileRPHs", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "InHouseTimeSpan", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class ProfileRPHs {
        ...
        @XmlElement(name = "ProfileRPH", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
