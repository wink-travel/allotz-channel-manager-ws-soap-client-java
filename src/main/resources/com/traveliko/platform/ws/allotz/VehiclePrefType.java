...
@XmlType(name = "VehiclePrefType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "vehMakeModel"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.VehicleAvailRQCoreType.VehPrefs.VehPref.class
})
