...
@XmlType(name = "VehicleRetrieveResRQCoreType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "uniqueID",
    "personName",
    "custLoyalty",
    "tpaExtensions"
...
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.OTAVehRetResRQ.VehRetResRQCore.class
})
