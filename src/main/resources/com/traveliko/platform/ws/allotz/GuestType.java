...
@XmlType(name = "GuestType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "guestName",
    "guestTransportation"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.CruiseBookingInfoType.GuestPrices.GuestPrice.class
})
public class GuestType {

    @XmlElement(name = "GuestName", namespace = "http://www.opentravel.org/OTA/2003/05")
