...
@XmlType(name = "FreeTextType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "value"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.PTCFareBreakdownType.Endorsements.Endorsement.class,
    CertificationType.class,
    com.traveliko.platform.ws.allotz.FareCodeOptionType.FareRemark.class,
    ErrorType.class,
    WarningType.class,
    com.traveliko.platform.ws.allotz.TicketingInfoType.TicketAdvisory.class,
