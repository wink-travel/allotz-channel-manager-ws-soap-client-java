...
@XmlType(name = "VehicleReservationRQCoreType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "uniqueID",
    "vehRentalCore",
    "customer",
    "vendorPref",
...
public class VehicleReservationRQCoreType {
    ...
    @XmlElement(name = "VehPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected VehiclePrefType vehPref;
    @XmlElement(name = "DriverType", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<VehicleReservationRQCoreType.DriverType> driverType;
    @XmlElement(name = "RateQualifier", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "VehicleCharges", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "RateDistance", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<VehicleReservationRQCoreType.RateDistance> rateDistance;
    @XmlElement(name = "TotalCharge", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected VehicleReservationRQCoreType.TotalCharge totalCharge;
    @XmlElement(name = "Queue", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class VehicleCharges {
        ...
        @XmlElement(name = "VehicleCharge", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
