...
@XmlType(name = "SpecialRemarkType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "travelerRefNumber",
    "flightRefNumber",
    "text",
    "airline",
...
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.SpecialReqDetailsType.SpecialRemarks.SpecialRemark.class
})
public class SpecialRemarkType {
    ...
    @XmlElement(name = "FlightRefNumber", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "Airline", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<CompanyNameType> airline;
    @XmlElement(name = "AuthorizedViewers", namespace = "http://www.opentravel.org/OTA/2003/05")
