...
@XmlType(name = "LocationGeneralType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "cityName",
    "stateProv",
    "countryName"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.CruisePackageType.Location.class
})
