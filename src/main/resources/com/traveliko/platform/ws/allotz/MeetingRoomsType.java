...
@XmlType(name = "MeetingRoomsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "meetingRoom"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.FacilityInfoType.MeetingRooms.class
})
public class MeetingRoomsType {

    @XmlElement(name = "MeetingRoom", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class MeetingRoom {
        ...
        @XmlElement(name = "Dimension", namespace = "http://www.opentravel.org/OTA/2003/05")
        protected MeetingRoomsType.MeetingRoom.Dimension dimension;
        @XmlElement(name = "AvailableCapacities", namespace = "http://www.opentravel.org/OTA/2003/05")
        ...
        public static class AvailableCapacities {
            ...
            @XmlElement(name = "MeetingRoomCapacity", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
