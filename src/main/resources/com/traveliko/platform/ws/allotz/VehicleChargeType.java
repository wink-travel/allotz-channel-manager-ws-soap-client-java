...
@XmlType(name = "VehicleChargeType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "taxAmounts",
    "minMax",
    "calculation"
})
@XmlSeeAlso({
    ...
    com.traveliko.platform.ws.allotz.VehicleLocationAdditionalFeesType.Fees.Fee.class,
    com.traveliko.platform.ws.allotz.VehicleLocationAdditionalFeesType.Surcharges.Surcharge.class,
    com.traveliko.platform.ws.allotz.VehicleLocationAdditionalFeesType.MiscellaneousCharges.MiscellaneousCharge.class
})
public class VehicleChargeType {

    @XmlElement(name = "TaxAmounts", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected VehicleChargeType.TaxAmounts taxAmounts;
    @XmlElement(name = "MinMax", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected VehicleChargeType.MinMax minMax;
    @XmlElement(name = "Calculation", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class TaxAmounts {
        ...
        @XmlElement(name = "TaxAmount", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
