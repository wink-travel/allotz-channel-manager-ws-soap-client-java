...
@XmlType(name = "RoomStayCandidateType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "guestCounts",
    "roomAmenity"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.AvailRequestSegmentsType.AvailRequestSegment.RoomStayCandidates.RoomStayCandidate.class,
