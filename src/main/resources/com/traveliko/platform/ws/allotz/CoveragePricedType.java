...
@XmlType(name = "CoveragePricedType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "coverage",
    "charge",
    "deductible"
})
public class CoveragePricedType {
    ...
    @XmlElement(name = "Coverage", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
