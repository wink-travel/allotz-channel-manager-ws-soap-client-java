...
@XmlType(name = "PaymentFormType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "paymentCard",
    "bankAcct",
    "directBill",
    "voucher",
...
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.CompanyInfoType.PaymentForm.class,
    com.traveliko.platform.ws.allotz.GuaranteeType.GuaranteesAccepted.GuaranteeAccepted.class,
    HotelPaymentFormType.class,
    com.traveliko.platform.ws.allotz.CustomerType.PaymentForm.class,
    PaymentDetailType.class,
    PaymentResponseType.class
})
public class PaymentFormType {

    @XmlElement(name = "PaymentCard", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected PaymentCardType paymentCard;
    @XmlElement(name = "BankAcct", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected BankAcctType bankAcct;
    @XmlElement(name = "DirectBill", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected DirectBillType directBill;
    @XmlElement(name = "Voucher", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected PaymentFormType.Voucher voucher;
    @XmlElement(name = "LoyaltyRedemption", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected PaymentFormType.LoyaltyRedemption loyaltyRedemption;
    @XmlElement(name = "MiscChargeOrder", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected PaymentFormType.MiscChargeOrder miscChargeOrder;
    @XmlElement(name = "Ticket", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected PaymentFormType.Ticket ticket;
    @XmlElement(name = "Cash", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class LoyaltyRedemption {
        ...
        @XmlElement(name = "LoyaltyCertificate", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class Ticket {
        ...
        @XmlElement(name = "ConjunctionTicketNbr", namespace = "http://www.opentravel.org/OTA/2003/05")
