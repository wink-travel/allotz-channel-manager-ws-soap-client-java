...
@XmlType(name = "HotelPaymentFormType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "masterAccountUsage"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.HotelRoomListType.Guests.Guest.GuaranteePayment.class
})
public class HotelPaymentFormType
    extends PaymentFormType
{

    @XmlElement(name = "MasterAccountUsage", namespace = "http://www.opentravel.org/OTA/2003/05")
