...
@XmlType(name = "PaymentDetailType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "paymentAmount",
    "commission"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.FulfillmentType.PaymentDetails.PaymentDetail.class,
    com.traveliko.platform.ws.allotz.VehicleReservationRQAdditionalInfoType.RentalPaymentPref.class,
    com.traveliko.platform.ws.allotz.CruiseGuestInfoType.PaymentOptions.PaymentOption.class
})
public class PaymentDetailType
    extends PaymentFormType
{

    @XmlElement(name = "PaymentAmount", namespace = "http://www.opentravel.org/OTA/2003/05")
