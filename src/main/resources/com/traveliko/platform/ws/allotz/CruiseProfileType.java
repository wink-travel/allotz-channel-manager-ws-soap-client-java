...
@XmlType(name = "CruiseProfileType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "cruiseProfile"
})
public class CruiseProfileType {

    @XmlElement(name = "CruiseProfile", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
