...
@XmlType(name = "BookingRulesType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "bookingRule"
})
public class BookingRulesType {

    @XmlElement(name = "BookingRule", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class BookingRule {
        ...
        @XmlElement(name = "AcceptableGuarantees", namespace = "http://www.opentravel.org/OTA/2003/05")
        protected BookingRulesType.BookingRule.AcceptableGuarantees acceptableGuarantees;
        @XmlElement(name = "CancelPenalties", namespace = "http://www.opentravel.org/OTA/2003/05")
        protected CancelPenaltiesType cancelPenalties;
        @XmlElement(name = "RequiredPaymts", namespace = "http://www.opentravel.org/OTA/2003/05")
        protected RequiredPaymentsType requiredPaymts;
        @XmlElement(name = "LengthsOfStay", namespace = "http://www.opentravel.org/OTA/2003/05")
        protected LengthsOfStayType lengthsOfStay;
        @XmlElement(name = "DOW_Restrictions", namespace = "http://www.opentravel.org/OTA/2003/05")
        protected DOWRestrictionsType dowRestrictions;
        @XmlElement(name = "RestrictionStatus", namespace = "http://www.opentravel.org/OTA/2003/05")
        protected BookingRulesType.BookingRule.RestrictionStatus restrictionStatus;
        @XmlElement(name = "Viewerships", namespace = "http://www.opentravel.org/OTA/2003/05")
        protected ViewershipsType viewerships;
        @XmlElement(name = "AddtionalRules", namespace = "http://www.opentravel.org/OTA/2003/05")
        ...
        @XmlElement(name = "CheckoutCharge", namespace = "http://www.opentravel.org/OTA/2003/05")
        ...
        public static class AcceptableGuarantees {
            ...
            @XmlElement(name = "AcceptableGuarantee", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
        ...
        public static class AddtionalRules {
            ...
            @XmlElement(name = "AdditionalRule", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
