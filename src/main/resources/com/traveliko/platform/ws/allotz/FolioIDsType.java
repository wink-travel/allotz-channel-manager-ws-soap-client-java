...
@XmlType(name = "FolioIDsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "folioID"
})
public class FolioIDsType {

    @XmlElement(name = "FolioID", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
