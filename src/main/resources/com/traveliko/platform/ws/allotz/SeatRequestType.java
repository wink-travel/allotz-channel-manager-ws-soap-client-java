...
@XmlType(name = "SeatRequestType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "departureAirport",
    "arrivalAirport",
    "airline"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.SpecialReqDetailsType.SeatRequests.SeatRequest.class
})
