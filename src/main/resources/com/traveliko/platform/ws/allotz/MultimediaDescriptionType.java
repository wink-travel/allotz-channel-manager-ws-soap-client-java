...
@XmlType(name = "MultimediaDescriptionType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "videoItems",
    "imageItems",
    "textItems"
})
public class MultimediaDescriptionType {
    ...
    @XmlElement(name = "VideoItems", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected VideoItemsType videoItems;
    @XmlElement(name = "ImageItems", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected ImageItemsType imageItems;
    @XmlElement(name = "TextItems", namespace = "http://www.opentravel.org/OTA/2003/05")
