...
@XmlType(name = "BasicPropertyInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "vendorMessages",
    "position",
    "address",
    "contactNumbers",
...
public class BasicPropertyInfoType {
    ...
    @XmlElement(name = "ContactNumbers", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "Policy", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class ContactNumbers {
        ...
        @XmlElement(name = "ContactNumber", namespace = "http://www.opentravel.org/OTA/2003/05")
