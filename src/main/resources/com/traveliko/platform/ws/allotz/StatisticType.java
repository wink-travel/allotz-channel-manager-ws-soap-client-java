...
@XmlType(name = "StatisticType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "statisticApplicationSets"
})
public class StatisticType {

    @XmlElement(name = "StatisticApplicationSets", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class StatisticApplicationSets {
        ...
        @XmlElement(name = "StatisticApplicationSet", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
