...
@XmlType(name = "HotelReservationIDsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "hotelReservationID"
})
public class HotelReservationIDsType {

    @XmlElement(name = "HotelReservationID", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
