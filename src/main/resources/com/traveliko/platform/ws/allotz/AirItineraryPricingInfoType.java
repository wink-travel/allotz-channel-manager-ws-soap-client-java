...
@XmlType(name = "AirItineraryPricingInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "itinTotalFare",
    "ptcFareBreakdowns",
    "fareInfos",
...
@XmlSeeAlso({
    ...
    com.traveliko.platform.ws.allotz.PricedItineraryType.AirItineraryPricingInfo.class
})
public class AirItineraryPricingInfoType {

    @XmlElement(name = "ItinTotalFare", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<AirItineraryPricingInfoType.ItinTotalFare> itinTotalFare;
    @XmlElement(name = "PTC_FareBreakdowns", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected AirItineraryPricingInfoType.PTCFareBreakdowns ptcFareBreakdowns;
    @XmlElement(name = "FareInfos", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class FareInfos {
        ...
        @XmlElement(name = "FareInfo", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class PTCFareBreakdowns {
        ...
        @XmlElement(name = "PTC_FareBreakdown", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
