...
@XmlType(name = "AirlinePrefType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "loyaltyPref",
    "vendorPref",
    "paymentFormPref",
    "airportOriginPref",
...
public class AirlinePrefType {
    ...
    @XmlElement(name = "LoyaltyPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<LoyaltyPrefType> loyaltyPref;
    @XmlElement(name = "VendorPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<AirlinePrefType.VendorPref> vendorPref;
    @XmlElement(name = "PaymentFormPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<PaymentFormPrefType> paymentFormPref;
    @XmlElement(name = "AirportOriginPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<AirportPrefType> airportOriginPref;
    @XmlElement(name = "AirportDestinationPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected AirportPrefType airportDestinationPref;
    @XmlElement(name = "AirportRoutePref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<AirportPrefType> airportRoutePref;
    @XmlElement(name = "FareRestrictPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<AirlinePrefType.FareRestrictPref> fareRestrictPref;
    @XmlElement(name = "FarePref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<AirlinePrefType.FarePref> farePref;
    @XmlElement(name = "TourCodePref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<AirlinePrefType.TourCodePref> tourCodePref;
    @XmlElement(name = "FlightTypePref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<AirlinePrefType.FlightTypePref> flightTypePref;
    @XmlElement(name = "EquipPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<EquipmentTypePref> equipPref;
    @XmlElement(name = "CabinPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<AirlinePrefType.CabinPref> cabinPref;
    @XmlElement(name = "SeatPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<AirlinePrefType.SeatPref> seatPref;
    @XmlElement(name = "TicketDistribPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<TicketDistribPrefType> ticketDistribPref;
    @XmlElement(name = "MealPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<MealPrefType> mealPref;
    @XmlElement(name = "SpecRequestPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<SpecRequestPrefType> specRequestPref;
    @XmlElement(name = "SSR_Pref", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "MediaEntertainPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<MediaEntertainPrefType> mediaEntertainPref;
    @XmlElement(name = "PetInfoPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<PetInfoPrefType> petInfoPref;
    @XmlElement(name = "AccountInformation", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected AirlinePrefType.AccountInformation accountInformation;
    @XmlElement(name = "OSI_Pref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<OtherServiceInfoType> osiPref;
    @XmlElement(name = "KeywordPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class AccountInformation {
        ...
        @XmlElement(name = "TaxRegistrationDetails", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class TourCodePref {
        ...
        @XmlElement(name = "TourCodeInfo", namespace = "http://www.opentravel.org/OTA/2003/05")
        protected AirlinePrefType.TourCodePref.TourCodeInfo tourCodeInfo;
        @XmlElement(name = "StaffTourCodeInfo", namespace = "http://www.opentravel.org/OTA/2003/05")
