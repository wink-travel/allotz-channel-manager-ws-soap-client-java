...
@XmlType(name = "ImageDescriptionType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "imageFormat",
    "description"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.ImageItemsType.ImageItem.class
})
public class ImageDescriptionType {

    @XmlElement(name = "ImageFormat", namespace = "http://www.opentravel.org/OTA/2003/05")
