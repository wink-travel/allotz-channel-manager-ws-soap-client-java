...
@XmlType(name = "InvBlockType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "hotelRef",
    "invBlockDates",
    "roomTypes",
    "methodInfo",
...
public class InvBlockType {
    ...
    @XmlElement(name = "InvBlockDates", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "MethodInfo", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected InvBlockType.MethodInfo methodInfo;
    @XmlElement(name = "BlockDescriptions", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected InvBlockType.BlockDescriptions blockDescriptions;
    @XmlElement(name = "Contacts", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected InvBlockType.Contacts contacts;
    @XmlElement(name = "DestinationSystemCodes", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class BlockDescriptions {
        ...
        @XmlElement(name = "BlockDescription", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class Contacts {
        ...
        @XmlElement(name = "Contact", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
