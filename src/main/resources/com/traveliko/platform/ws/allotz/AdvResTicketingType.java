...
@XmlType(name = "AdvResTicketingType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "advReservation",
    "advTicketing"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.RuleInfoType.ResTicketingRules.AdvResTicketing.class
})
public class AdvResTicketingType {

    @XmlElement(name = "AdvReservation", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected AdvResTicketingType.AdvReservation advReservation;
    @XmlElement(name = "AdvTicketing", namespace = "http://www.opentravel.org/OTA/2003/05")
