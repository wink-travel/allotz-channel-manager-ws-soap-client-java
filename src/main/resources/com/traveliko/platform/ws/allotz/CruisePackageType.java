...
@XmlType(name = "CruisePackageType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "location"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.CruiseGuestDetailType.SelectedPackages.SelectedPackage.class
})
public class CruisePackageType {

    @XmlElement(name = "Location", namespace = "http://www.opentravel.org/OTA/2003/05")
