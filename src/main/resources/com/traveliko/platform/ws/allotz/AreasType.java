...
@XmlType(name = "AreasType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "area"
})
public class AreasType {

    @XmlElement(name = "Area", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class Area {
        ...
        @XmlElement(name = "AreaDescription", namespace = "http://www.opentravel.org/OTA/2003/05")
