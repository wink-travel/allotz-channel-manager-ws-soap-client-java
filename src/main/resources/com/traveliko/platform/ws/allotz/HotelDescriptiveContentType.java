...
@XmlType(name = "HotelDescriptiveContentType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
...
public class HotelDescriptiveContentType {
    ...
    @XmlElement(name = "DestinationSystemsCode", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "Policies", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "GDS_Info", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "EffectivePeriods", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class EffectivePeriods {
        ...
        @XmlElement(name = "EffectivePeriod", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
