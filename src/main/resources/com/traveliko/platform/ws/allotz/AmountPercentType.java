...
@XmlType(name = "AmountPercentType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "taxes"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.RequiredPaymentsType.GuaranteePayment.AmountPercent.class
})
