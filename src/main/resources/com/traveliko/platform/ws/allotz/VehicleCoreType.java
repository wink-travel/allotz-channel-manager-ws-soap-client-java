...
@XmlType(name = "VehicleCoreType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "vehType",
    "vehClass"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.VehicleAgeRequirementsType.Age.Vehicles.Vehicle.class,
    VehiclePrefType.class,
    VehicleType.class,
    com.traveliko.platform.ws.allotz.VehicleAdditionalDriverRequirementsType.AddlDriverInfos.Vehicles.Vehicle.class
})
public class VehicleCoreType {

    @XmlElement(name = "VehType", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected VehicleCoreType.VehType vehType;
    @XmlElement(name = "VehClass", namespace = "http://www.opentravel.org/OTA/2003/05")
