...
@XmlType(name = "PkgRoomInventoryType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "supplementCharges"
})
    ...
    extends RoomStayCandidateType
{
    ...
    @XmlElement(name = "SupplementCharges", namespace = "http://www.opentravel.org/OTA/2003/05")
