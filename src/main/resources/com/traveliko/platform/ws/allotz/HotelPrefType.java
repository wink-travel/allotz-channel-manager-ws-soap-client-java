...
@XmlType(name = "HotelPrefType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "loyaltyPref",
    "paymentFormPref",
    "hotelChainPref",
    "propertyNamePref",
...
public class HotelPrefType {
    ...
    @XmlElement(name = "HotelChainPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<CompanyNamePrefType> hotelChainPref;
    @XmlElement(name = "PropertyNamePref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<PropertyNamePrefType> propertyNamePref;
    @XmlElement(name = "PropertyLocationPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<PropertyLocationPrefType> propertyLocationPref;
    @XmlElement(name = "PropertyTypePref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<PropertyTypePrefType> propertyTypePref;
    @XmlElement(name = "PropertyClassPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<PropertyClassPrefType> propertyClassPref;
    @XmlElement(name = "PropertyAmenityPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<PropertyAmenityPrefType> propertyAmenityPref;
    @XmlElement(name = "RoomAmenityPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<RoomAmenityPrefType> roomAmenityPref;
    @XmlElement(name = "RoomLocationPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<RoomLocationPrefType> roomLocationPref;
    @XmlElement(name = "BedTypePref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<BedTypePrefType> bedTypePref;
    @XmlElement(name = "FoodSrvcPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "RecreationSrvcPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<RecreationSrvcPrefType> recreationSrvcPref;
    @XmlElement(name = "BusinessSrvcPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<BusinessSrvcPrefType> businessSrvcPref;
    @XmlElement(name = "PersonalSrvcPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<PersonalSrvcPrefType> personalSrvcPref;
    @XmlElement(name = "SecurityFeaturePref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<SecurityFeaturePrefType> securityFeaturePref;
    @XmlElement(name = "PhysChallFeaturePref", namespace = "http://www.opentravel.org/OTA/2003/05")
