...
@XmlType(name = "FareCodeOptionType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "fareRemark"
})
public class FareCodeOptionType {

    @XmlElement(name = "FareRemark", namespace = "http://www.opentravel.org/OTA/2003/05")
