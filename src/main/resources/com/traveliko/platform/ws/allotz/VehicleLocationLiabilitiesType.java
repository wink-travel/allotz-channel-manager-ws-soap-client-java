...
@XmlType(name = "VehicleLocationLiabilitiesType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "coverages",
    "info",
    "tpaExtensions"
})
public class VehicleLocationLiabilitiesType {
    ...
    @XmlElement(name = "Coverages", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected VehicleLocationLiabilitiesType.Coverages coverages;
    @XmlElement(name = "Info", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class Coverages {
        ...
        @XmlElement(name = "Coverage", namespace = "http://www.opentravel.org/OTA/2003/05")
        ...
        public static class Coverage {
            ...
            @XmlElement(name = "CoverageInfo", namespace = "http://www.opentravel.org/OTA/2003/05")
            protected FormattedTextType coverageInfo;
            @XmlElement(name = "CoverageFees", namespace = "http://www.opentravel.org/OTA/2003/05")
            ...
            public static class CoverageFees {
                ...
                @XmlElement(name = "CoverageFee", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
                ...
                public static class CoverageFee {
                    ...
                    @XmlElement(name = "Vehicles", namespace = "http://www.opentravel.org/OTA/2003/05")
