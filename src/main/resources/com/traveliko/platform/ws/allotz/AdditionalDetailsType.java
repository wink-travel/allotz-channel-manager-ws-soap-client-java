...
@XmlType(name = "AdditionalDetailsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "additionalDetail"
})
public class AdditionalDetailsType {

    @XmlElement(name = "AdditionalDetail", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
