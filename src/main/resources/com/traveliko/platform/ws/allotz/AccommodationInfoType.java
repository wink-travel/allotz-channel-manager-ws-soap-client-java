...
@XmlType(name = "AccommodationInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "property",
    "resort",
    "accommodationClass",
...
public class AccommodationInfoType {
    ...
    @XmlElement(name = "Property", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    protected PropertyIdentityType property;
    @XmlElement(name = "Resort", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected AccommodationInfoType.Resort resort;
    @XmlElement(name = "AccommodationClass", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected AccommodationInfoType.AccommodationClass accommodationClass;
    @XmlElement(name = "SourceIdentification", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected SourceIdentificationType sourceIdentification;
    @XmlElement(name = "ContentInfo", namespace = "http://www.opentravel.org/OTA/2003/05")
