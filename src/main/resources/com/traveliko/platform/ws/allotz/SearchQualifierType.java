...
@XmlType(name = "SearchQualifierType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "reservationID",
    "residency",
    "priceRange",
    "status",
...
public class SearchQualifierType {
    ...
    @XmlElement(name = "Residency", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected SearchQualifierType.Residency residency;
    @XmlElement(name = "PriceRange", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected SearchQualifierType.PriceRange priceRange;
    @XmlElement(name = "Status", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<SearchQualifierType.Status> status;
    @XmlElement(name = "Dining", namespace = "http://www.opentravel.org/OTA/2003/05")
