...
@XmlType(name = "SpecialServiceRequestType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "airline",
    "text"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.SpecialReqDetailsType.SpecialServiceRequests.SpecialServiceRequest.class
})
