...
@XmlType(name = "CruiseReservationType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "sailingInfo",
    "sailingProfile",
    "reservationInfo",
    "paymentsDue",
...
public class CruiseReservationType {
    ...
    @XmlElement(name = "SailingInfo", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    protected SailingCategoryInfoType sailingInfo;
    @XmlElement(name = "SailingProfile", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<CruiseProfileType> sailingProfile;
    @XmlElement(name = "ReservationInfo", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    protected CruiseGuestInfoType reservationInfo;
    @XmlElement(name = "PaymentsDue", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected CruiseReservationType.PaymentsDue paymentsDue;
    @XmlElement(name = "Information", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class PaymentsDue {
        ...
        @XmlElement(name = "PaymentDue", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
