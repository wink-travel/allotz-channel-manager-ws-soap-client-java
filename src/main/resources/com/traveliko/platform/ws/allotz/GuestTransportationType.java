...
@XmlType(name = "GuestTransportationType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "guestCity",
    "gatewayCity"
})
public class GuestTransportationType {

    @XmlElement(name = "GuestCity", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected LocationType guestCity;
    @XmlElement(name = "GatewayCity", namespace = "http://www.opentravel.org/OTA/2003/05")
