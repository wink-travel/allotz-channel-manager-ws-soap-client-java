...
@XmlType(name = "RatePlanType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "guarantee",
    "cancelPenalties",
    "ratePlanDescription",
    "ratePlanInclusions",
...
public class RatePlanType {
    ...
    @XmlElement(name = "RatePlanDescription", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected ParagraphType ratePlanDescription;
    @XmlElement(name = "RatePlanInclusions", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class RatePlanInclusions {
        ...
        @XmlElement(name = "RatePlanInclusionDesciption", namespace = "http://www.opentravel.org/OTA/2003/05")
