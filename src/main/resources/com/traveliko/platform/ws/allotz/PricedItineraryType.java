...
@XmlType(name = "PricedItineraryType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "airItinerary",
...
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.PricedItinerariesType.PricedItinerary.class
})
public class PricedItineraryType {
    ...
    @XmlElement(name = "AirItineraryPricingInfo", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected PricedItineraryType.AirItineraryPricingInfo airItineraryPricingInfo;
    @XmlElement(name = "Notes", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<FreeTextType> notes;
    @XmlElement(name = "TicketingInfo", namespace = "http://www.opentravel.org/OTA/2003/05")
        ...
        extends TicketingInfoRSType
    {
        ...
        @XmlElement(name = "DeliveryInfo", namespace = "http://www.opentravel.org/OTA/2003/05")
