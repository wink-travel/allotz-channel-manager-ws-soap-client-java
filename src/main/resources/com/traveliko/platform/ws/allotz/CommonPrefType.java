...
@XmlType(name = "CommonPrefType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "namePref",
    "phonePref",
    "addressPref",
    "paymentFormPref",
...
public class CommonPrefType {
    ...
    @XmlElement(name = "NamePref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<NamePrefType> namePref;
    @XmlElement(name = "PhonePref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<PhonePrefType> phonePref;
    @XmlElement(name = "AddressPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "InterestPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<InterestPrefType> interestPref;
    @XmlElement(name = "InsurancePref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<InsurancePrefType> insurancePref;
    @XmlElement(name = "SeatingPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "RelatedTravelerPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<RelatedTravelerPrefType> relatedTravelerPref;
    @XmlElement(name = "ContactPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<CommonPrefType.ContactPref> contactPref;
    @XmlElement(name = "EmployeeLevelInfo", namespace = "http://www.opentravel.org/OTA/2003/05")
