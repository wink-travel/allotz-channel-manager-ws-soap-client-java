...
@XmlType(name = "TravelerInfoSummaryType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "seatsRequested",
    "airTravelerAvail",
...
public class TravelerInfoSummaryType {
    ...
    @XmlElement(name = "SeatsRequested", namespace = "http://www.opentravel.org/OTA/2003/05")
    @XmlSchemaType(name = "nonNegativeInteger")
    protected List<BigInteger> seatsRequested;
    @XmlElement(name = "AirTravelerAvail", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<TravelerInformationType> airTravelerAvail;
    @XmlElement(name = "PriceRequestInformation", namespace = "http://www.opentravel.org/OTA/2003/05")
        ...
        extends PriceRequestInformationType
    {
        ...
        @XmlElement(name = "FareRestrictionPref", namespace = "http://www.opentravel.org/OTA/2003/05")
        protected List<TravelerInfoSummaryType.PriceRequestInformation.FareRestrictionPref> fareRestrictionPref;
        @XmlElement(name = "Tax", namespace = "http://www.opentravel.org/OTA/2003/05")
        ...
        @XmlElement(name = "SegmentOverride", namespace = "http://www.opentravel.org/OTA/2003/05")
        protected List<TravelerInfoSummaryType.PriceRequestInformation.SegmentOverride> segmentOverride;
        @XmlElement(name = "Account", namespace = "http://www.opentravel.org/OTA/2003/05")
        protected List<TravelerInfoSummaryType.PriceRequestInformation.Account> account;
        @XmlElement(name = "LocationRequirement", namespace = "http://www.opentravel.org/OTA/2003/05")
        ...
        public static class DiscountPricing {
            ...
            @XmlElement(name = "FlightReference", namespace = "http://www.opentravel.org/OTA/2003/05")
