...
@XmlType(name = "VehicleEquipmentType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "description"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.VehicleRentalTransactionType.PricedEquips.PricedEquip.Equipment.class
})
