...
@XmlType(name = "CruiseBookingInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "bookingPrices",
    "paymentSchedule",
    "guestPrices",
    "policyInfo"
...
public class CruiseBookingInfoType {
    ...
    @XmlElement(name = "BookingPrices", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected CruiseBookingInfoType.BookingPrices bookingPrices;
    @XmlElement(name = "PaymentSchedule", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected CruiseBookingInfoType.PaymentSchedule paymentSchedule;
    @XmlElement(name = "GuestPrices", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class BookingPrices {
        ...
        @XmlElement(name = "BookingPrice", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class GuestPrices {
        ...
        @XmlElement(name = "GuestPrice", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
            ...
            extends GuestType
        {
            ...
            @XmlElement(name = "PriceInfos", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
            ...
            public static class PriceInfos {
                ...
                @XmlElement(name = "PriceInfo", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class PaymentSchedule {
        ...
        @XmlElement(name = "Payment", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
