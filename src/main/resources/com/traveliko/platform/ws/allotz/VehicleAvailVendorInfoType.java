...
@XmlType(name = "VehicleAvailVendorInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "vendorMessages",
    "offLocServices",
    "paymentRules",
    "locationDetails",
...
public class VehicleAvailVendorInfoType {
    ...
    @XmlElement(name = "OffLocServices", namespace = "http://www.opentravel.org/OTA/2003/05")
