...
@XmlType(name = "ProductDescriptionsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "productDescription"
})
public class ProductDescriptionsType {

    @XmlElement(name = "ProductDescription", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
