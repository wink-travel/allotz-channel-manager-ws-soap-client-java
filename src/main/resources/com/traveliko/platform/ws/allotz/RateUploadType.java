...
@XmlType(name = "RateUploadType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "baseByGuestAmts",
...
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.RateAmountMessageType.Rates.Rate.class,
    com.traveliko.platform.ws.allotz.InvBlockRoomType.RatePlans.RatePlan.class
})
public class RateUploadType {

    @XmlElement(name = "BaseByGuestAmts", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected RateUploadType.BaseByGuestAmts baseByGuestAmts;
    @XmlElement(name = "AdditionalGuestAmounts", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected RateUploadType.AdditionalGuestAmounts additionalGuestAmounts;
    @XmlElement(name = "Fees", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected FeesType fees;
    @XmlElement(name = "GuaranteePolicies", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected RateUploadType.GuaranteePolicies guaranteePolicies;
    @XmlElement(name = "CancelPolicies", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected CancelPenaltiesType cancelPolicies;
    @XmlElement(name = "PaymentPolicies", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected RequiredPaymentsType paymentPolicies;
    @XmlElement(name = "RateDescription", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected ParagraphType rateDescription;
    @XmlElement(name = "UniqueID", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected UniqueIDType uniqueID;
    @XmlElement(name = "MealsIncluded", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected RateUploadType.MealsIncluded mealsIncluded;
    @XmlElement(name = "AdditionalCharges", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class AdditionalGuestAmounts {
        ...
        @XmlElement(name = "AdditionalGuestAmount", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
        ...
        public static class AdditionalGuestAmount {
            ...
            @XmlElement(name = "AddlGuestAmtDescription", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class BaseByGuestAmts {
        ...
        @XmlElement(name = "BaseByGuestAmt", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
            ...
            extends TotalType
        {
            ...
            @XmlElement(name = "NumberOfGuestsDescription", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class GuaranteePolicies {
        ...
        @XmlElement(name = "GuaranteePolicy", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
