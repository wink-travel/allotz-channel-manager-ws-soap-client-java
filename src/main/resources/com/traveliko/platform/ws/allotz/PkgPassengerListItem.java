...
@XmlType(name = "PkgPassengerListItem", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "name",
    "specialNeed",
    "passportInformation"
})
public class PkgPassengerListItem {
    ...
    @XmlElement(name = "SpecialNeed", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<PkgPassengerListItem.SpecialNeed> specialNeed;
    @XmlElement(name = "PassportInformation", namespace = "http://www.opentravel.org/OTA/2003/05")
