...
@XmlType(name = "AirTravelerType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "profileRef",
    "personName",
    "telephone",
    "email",
...
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.TravelerInfoType.AirTraveler.class
})
public class AirTravelerType {
    ...
    @XmlElement(name = "PassengerTypeQuantity", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "FlightSegmentRPHs", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class FlightSegmentRPHs {
        ...
        @XmlElement(name = "FlightSegmentRPH", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
