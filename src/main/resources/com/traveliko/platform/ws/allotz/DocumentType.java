...
@XmlType(name = "DocumentType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "docHolderName",
...
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.AirTravelerType.Document.class
})
public class DocumentType {

    @XmlElement(name = "DocHolderName", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected String docHolderName;
    @XmlElement(name = "DocHolderFormattedName", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected PersonNameType docHolderFormattedName;
    @XmlElement(name = "DocLimitations", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<String> docLimitations;
    @XmlElement(name = "AdditionalPersonNames", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class AdditionalPersonNames {
        ...
        @XmlElement(name = "AdditionalPersonName", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
