...
@XmlType(name = "BookFlightSegmentType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "marriageGrp",
    "bookingClassAvails",
    "comment",
    "stopLocation"
...
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.PTCFareBreakdownType.PricingUnit.FareComponent.FlightLeg.class,
    com.traveliko.platform.ws.allotz.OriginDestinationOptionType.FlightSegment.class
})
    ...
    extends FlightSegmentType
{
    ...
    @XmlElement(name = "BookingClassAvails", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "StopLocation", namespace = "http://www.opentravel.org/OTA/2003/05")
