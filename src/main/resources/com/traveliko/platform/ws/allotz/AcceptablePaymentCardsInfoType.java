...
@XmlType(name = "AcceptablePaymentCardsInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "acceptablePaymentCards",
    "info"
})
public class AcceptablePaymentCardsInfoType {

    @XmlElement(name = "AcceptablePaymentCards", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class AcceptablePaymentCards {
        ...
        @XmlElement(name = "AcceptablePaymentCard", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
