...
@XmlType(name = "CustomerType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "personName",
    "telephone",
    "email",
    "address",
...
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.CustomerPrimaryAdditionalType.Primary.class,
    com.traveliko.platform.ws.allotz.CustomerPrimaryAdditionalType.Additional.class
})
public class CustomerType {
    ...
    @XmlElement(name = "PhysChallName", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<CustomerType.PhysChallName> physChallName;
    @XmlElement(name = "PetInfo", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<String> petInfo;
    @XmlElement(name = "PaymentForm", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<CustomerType.PaymentForm> paymentForm;
    @XmlElement(name = "RelatedTraveler", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<RelatedTravelerType> relatedTraveler;
    @XmlElement(name = "ContactPerson", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "CustLoyalty", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<CustomerType.CustLoyalty> custLoyalty;
    @XmlElement(name = "EmployeeInfo", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<EmployeeInfoType> employeeInfo;
    @XmlElement(name = "EmployerInfo", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected CompanyNameType employerInfo;
    @XmlElement(name = "AdditionalLanguage", namespace = "http://www.opentravel.org/OTA/2003/05")
        ...
        extends AddressInfoType
    {
        ...
        @XmlElement(name = "AddresseeName", namespace = "http://www.opentravel.org/OTA/2003/05")
        ...
        extends PaymentFormType
    {
        ...
        @XmlElement(name = "AssociatedSupplier", namespace = "http://www.opentravel.org/OTA/2003/05")
