...
@XmlType(name = "MessageType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "originalPayloadStdAttributes",
    "messageContent"
})
public class MessageType {

    @XmlElement(name = "OriginalPayloadStdAttributes", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected MessageType.OriginalPayloadStdAttributes originalPayloadStdAttributes;
    @XmlElement(name = "MessageContent", namespace = "http://www.opentravel.org/OTA/2003/05")
