...
@XmlType(name = "EmailType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "value"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.CompanyInfoType.Email.class,
    com.traveliko.platform.ws.allotz.EmailsType.Email.class,
    com.traveliko.platform.ws.allotz.CustomerType.Email.class,
    com.traveliko.platform.ws.allotz.AirTravelerType.Email.class
})
