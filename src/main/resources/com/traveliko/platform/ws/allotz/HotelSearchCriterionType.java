...
@XmlType(name = "HotelSearchCriterionType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "hotelAmenity",
    "roomAmenity",
    "hotelFeature",
    "award",
...
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.HotelSearchCriteriaType.Criterion.class
})
public class HotelSearchCriterionType
    extends ItemSearchCriterionType
{

    @XmlElement(name = "HotelAmenity", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<HotelSearchCriterionType.HotelAmenity> hotelAmenity;
    @XmlElement(name = "RoomAmenity", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<RoomAmenityPrefType> roomAmenity;
    @XmlElement(name = "HotelFeature", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "Recreation", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<HotelSearchCriterionType.Recreation> recreation;
    @XmlElement(name = "Service", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<HotelSearchCriterionType.Service> service;
    @XmlElement(name = "Transportation", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "Media", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<HotelSearchCriterionType.Media> media;
    @XmlElement(name = "HotelMeetingFacility", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected HotelSearchCriterionType.HotelMeetingFacility hotelMeetingFacility;
    @XmlElement(name = "MealPlan", namespace = "http://www.opentravel.org/OTA/2003/05")
