...
@XmlType(name = "TravelClubType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "travelClubName",
    "clubMemberName"
})
public class TravelClubType {

    @XmlElement(name = "TravelClubName", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    protected CompanyNameType travelClubName;
    @XmlElement(name = "ClubMemberName", namespace = "http://www.opentravel.org/OTA/2003/05")
