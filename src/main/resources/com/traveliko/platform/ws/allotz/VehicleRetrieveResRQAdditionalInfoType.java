...
@XmlType(name = "VehicleRetrieveResRQAdditionalInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "pickUpLocation",
    "returnLocation",
    "telephone",
    "vendor",
...
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.OTAVehRetResRQ.VehRetResRQInfo.class
})
public class VehicleRetrieveResRQAdditionalInfoType {
    ...
    @XmlElement(name = "SearchDateRange", namespace = "http://www.opentravel.org/OTA/2003/05")
