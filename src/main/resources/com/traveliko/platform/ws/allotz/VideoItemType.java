...
@XmlType(name = "VideoItemType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "url"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.VideoDescriptionType.VideoFormat.class
})
