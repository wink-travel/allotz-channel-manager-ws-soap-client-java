...
@XmlType(name = "ConnectionType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "connectionLocation"
})
public class ConnectionType {

    @XmlElement(name = "ConnectionLocation", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
