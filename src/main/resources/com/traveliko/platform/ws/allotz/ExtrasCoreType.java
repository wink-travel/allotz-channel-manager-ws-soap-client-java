...
@XmlType(name = "ExtrasCoreType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "subCategory"
})
@XmlSeeAlso({
    ExtrasType.class,
...
public class ExtrasCoreType {
    ...
    @XmlElement(name = "SubCategory", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public List<ExtrasCoreType.SubCategory> getSubCategory() {
        if (subCategory == null) {
            subCategory = new ArrayList<ExtrasCoreType.SubCategory>();
        }
