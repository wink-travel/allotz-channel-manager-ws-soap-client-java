...
@XmlType(name = "SailingInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "selectedSailing",
...
public class SailingInfoType {
    ...
    @XmlElement(name = "SelectedSailing", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected SailingInfoType.SelectedSailing selectedSailing;
    @XmlElement(name = "InclusivePackageOption", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected SailingInfoType.InclusivePackageOption inclusivePackageOption;
    @XmlElement(name = "Currency", namespace = "http://www.opentravel.org/OTA/2003/05")
