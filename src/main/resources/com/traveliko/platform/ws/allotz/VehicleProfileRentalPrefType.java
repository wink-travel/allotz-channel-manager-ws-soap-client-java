...
@XmlType(name = "VehicleProfileRentalPrefType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "loyaltyPref",
    "vendorPref",
    "paymentFormPref",
    "coveragePref",
...
public class VehicleProfileRentalPrefType {
    ...
    @XmlElement(name = "CoveragePref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<VehicleProfileRentalPrefType.CoveragePref> coveragePref;
    @XmlElement(name = "SpecialReqPref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<VehicleSpecialReqPrefType> specialReqPref;
    @XmlElement(name = "VehTypePref", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<VehiclePrefType> vehTypePref;
    @XmlElement(name = "SpecialEquipPref", namespace = "http://www.opentravel.org/OTA/2003/05")
