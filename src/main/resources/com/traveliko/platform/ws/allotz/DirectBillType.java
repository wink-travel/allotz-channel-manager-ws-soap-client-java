...
@XmlType(name = "DirectBillType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "companyName",
    "address",
    "email",
    "telephone"
...
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.HotelRoomListType.MasterAccount.class
})
