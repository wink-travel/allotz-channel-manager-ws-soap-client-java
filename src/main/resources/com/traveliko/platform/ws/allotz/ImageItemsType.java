...
@XmlType(name = "ImageItemsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "imageItem"
})
public class ImageItemsType {

    @XmlElement(name = "ImageItem", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
