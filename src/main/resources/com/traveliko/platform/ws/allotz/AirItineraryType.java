...
@XmlType(name = "AirItineraryType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "originDestinationOptions"
})
public class AirItineraryType {

    @XmlElement(name = "OriginDestinationOptions", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class OriginDestinationOptions {
        ...
        @XmlElement(name = "OriginDestinationOption", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
