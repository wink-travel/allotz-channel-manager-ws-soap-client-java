...
@XmlType(name = "RevenueCategoryType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "summaryAmount",
    "revenueDetails"
})
public class RevenueCategoryType {

    @XmlElement(name = "SummaryAmount", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected RevenueCategoryType.SummaryAmount summaryAmount;
    @XmlElement(name = "RevenueDetails", namespace = "http://www.opentravel.org/OTA/2003/05")
