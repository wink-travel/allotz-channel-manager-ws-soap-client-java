...
@XmlType(name = "CategoryOptionType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "priceInfos",
    "dining"
})
public class CategoryOptionType {

    @XmlElement(name = "PriceInfos", namespace = "http://www.opentravel.org/OTA/2003/05")
