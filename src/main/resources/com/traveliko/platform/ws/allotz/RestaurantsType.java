...
@XmlType(name = "RestaurantsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "restaurant",
    "srvcInfoCodes"
})
public class RestaurantsType {

    @XmlElement(name = "Restaurant", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<RestaurantsType.Restaurant> restaurant;
    @XmlElement(name = "SrvcInfoCodes", namespace = "http://www.opentravel.org/OTA/2003/05")
        ...
        extends RestaurantType
    {
        ...
        public static class SrvcInfoCodes {
            ...
            @XmlElement(name = "SrvcInfoCode", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
