...
@XmlType(name = "VehicleReservationRQAdditionalInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "specialReqPref",
    "coveragePrefs",
    "offLocService",
    "arrivalDetails",
...
public class VehicleReservationRQAdditionalInfoType {
    ...
    @XmlElement(name = "OffLocService", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "RentalPaymentPref", namespace = "http://www.opentravel.org/OTA/2003/05")
