...
@XmlType(name = "CustomerCountsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "customerCount"
})
public class CustomerCountsType {

    @XmlElement(name = "CustomerCount", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
