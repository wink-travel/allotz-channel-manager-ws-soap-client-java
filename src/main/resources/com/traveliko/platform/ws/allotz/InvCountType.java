...
@XmlType(name = "InvCountType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "inventory",
    "uniqueID"
})
public class InvCountType {

    @XmlElement(name = "Inventory", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
