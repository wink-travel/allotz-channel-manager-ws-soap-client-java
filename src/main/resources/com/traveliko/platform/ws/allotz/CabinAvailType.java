...
@XmlType(name = "CabinAvailType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "seat",
    "baggageAllowance"
})
public class CabinAvailType {

    @XmlElement(name = "Seat", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
