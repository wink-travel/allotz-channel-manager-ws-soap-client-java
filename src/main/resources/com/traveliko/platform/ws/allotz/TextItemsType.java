...
@XmlType(name = "TextItemsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "textItem"
})
public class TextItemsType {

    @XmlElement(name = "TextItem", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
