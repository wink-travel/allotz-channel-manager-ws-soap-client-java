...
@XmlType(name = "VehicleType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "vehMakeModel",
    "pictureURL",
    "vehIdentity"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.VehicleLocationLiabilitiesType.Coverages.Coverage.CoverageFees.CoverageFee.Vehicles.Vehicle.class,
    com.traveliko.platform.ws.allotz.VehicleLocationVehiclesType.Vehicle.class,
    com.traveliko.platform.ws.allotz.VehicleRentalTransactionType.Vehicle.class
})
public class VehicleType
    extends VehicleCoreType
{

    @XmlElement(name = "VehMakeModel", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected VehicleType.VehMakeModel vehMakeModel;
    @XmlElement(name = "PictureURL", namespace = "http://www.opentravel.org/OTA/2003/05")
    @XmlSchemaType(name = "anyURI")
    protected String pictureURL;
    @XmlElement(name = "VehIdentity", namespace = "http://www.opentravel.org/OTA/2003/05")
