...
@XmlType(name = "OtherServiceInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "travelerRefNumber",
    "airline",
    "text"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.SpecialReqDetailsType.OtherServiceInformations.OtherServiceInformation.class
})
