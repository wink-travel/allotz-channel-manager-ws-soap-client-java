...
@XmlType(name = "PaymentResponseType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "paymentAmount",
    "paymentReferenceID",
    "error"
})
    ...
    extends PaymentFormType
{
    ...
    @XmlElement(name = "PaymentReferenceID", namespace = "http://www.opentravel.org/OTA/2003/05")
