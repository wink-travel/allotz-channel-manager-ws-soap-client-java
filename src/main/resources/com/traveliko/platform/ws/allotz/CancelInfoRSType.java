...
@XmlType(name = "CancelInfoRSType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "cancelRules",
    "uniqueID"
})
public class CancelInfoRSType {

    @XmlElement(name = "CancelRules", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class CancelRules {
        ...
        @XmlElement(name = "CancelRule", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
