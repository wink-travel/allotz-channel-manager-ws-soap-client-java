...
@XmlType(name = "RefPointsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "refPoint"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.AreaInfoType.RefPoints.class
})
public class RefPointsType {

    @XmlElement(name = "RefPoint", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
