...
@XmlType(name = "AuthorizationType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "checkAuthorization",
...
public class AuthorizationType {
    ...
    @XmlElement(name = "CheckAuthorization", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected AuthorizationType.CheckAuthorization checkAuthorization;
    @XmlElement(name = "CreditCardAuthorization", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected AuthorizationType.CreditCardAuthorization creditCardAuthorization;
    @XmlElement(name = "AccountAuthorization", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected AuthorizationType.AccountAuthorization accountAuthorization;
    @XmlElement(name = "DriversLicenseAuthorization", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected DocumentType driversLicenseAuthorization;
    @XmlElement(name = "BookingReferenceID", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class AccountAuthorization {
        ...
        @XmlElement(name = "AccountInfo", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class CheckAuthorization {
        ...
        @XmlElement(name = "BankAcct", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    ...
    public static class CreditCardAuthorization {
        ...
        @XmlElement(name = "CreditCard", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
        protected PaymentCardType creditCard;
        @XmlElement(name = "ID", namespace = "http://www.opentravel.org/OTA/2003/05")
