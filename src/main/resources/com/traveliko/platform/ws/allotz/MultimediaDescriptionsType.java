...
@XmlType(name = "MultimediaDescriptionsType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "multimediaDescription"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.HotelInfoType.Descriptions.MultimediaDescriptions.class,
    com.traveliko.platform.ws.allotz.RestaurantType.MultimediaDescriptions.class,
    com.traveliko.platform.ws.allotz.AreaInfoType.Recreations.Recreation.MultimediaDescriptions.class
})
