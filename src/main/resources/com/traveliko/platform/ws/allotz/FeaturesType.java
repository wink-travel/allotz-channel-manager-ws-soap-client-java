...
@XmlType(name = "FeaturesType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "feature"
})
public class FeaturesType {

    @XmlElement(name = "Feature", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
