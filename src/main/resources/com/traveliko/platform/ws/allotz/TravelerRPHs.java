...
@XmlType(name = "TravelerRPHs", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "travelerRPH"
})
public class TravelerRPHs {

    @XmlElement(name = "TravelerRPH", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
