...
@XmlType(name = "VehicleAvailCoreType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "vehicle",
    "rentalRate",
    "totalCharge",
    "pricedEquips",
...
public class VehicleAvailCoreType {
    ...
    @XmlElement(name = "VendorLocation", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected VehicleAvailCoreType.VendorLocation vendorLocation;
    @XmlElement(name = "DropOffLocation", namespace = "http://www.opentravel.org/OTA/2003/05")
