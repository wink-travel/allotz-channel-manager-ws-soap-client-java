...
@XmlType(name = "PkgPassengerRPHs", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "passengerRPH"
})
public class PkgPassengerRPHs {

    @XmlElement(name = "PassengerRPH", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
