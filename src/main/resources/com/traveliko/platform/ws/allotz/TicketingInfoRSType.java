...
@XmlType(name = "TicketingInfoRS_Type", namespace = "http://www.opentravel.org/OTA/2003/05")
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.PricedItineraryType.TicketingInfo.class
})
