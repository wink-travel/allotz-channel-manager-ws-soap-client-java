...
@XmlType(name = "PhonesType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "phone"
})
public class PhonesType {

    @XmlElement(name = "Phone", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
