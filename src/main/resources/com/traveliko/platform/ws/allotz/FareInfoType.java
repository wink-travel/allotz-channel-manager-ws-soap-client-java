...
@XmlType(name = "FareInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "departureDate",
    "fareReference",
    "ruleInfo",
    "filingAirline",
...
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.PTCFareBreakdownType.FareInfo.class,
    com.traveliko.platform.ws.allotz.AirItineraryPricingInfoType.FareInfos.FareInfo.class
})
public class FareInfoType {

    @XmlElement(name = "DepartureDate", namespace = "http://www.opentravel.org/OTA/2003/05")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar departureDate;
    @XmlElement(name = "FareReference", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<FareInfoType.FareReference> fareReference;
    @XmlElement(name = "RuleInfo", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected FareInfoType.RuleInfo ruleInfo;
    @XmlElement(name = "FilingAirline", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected CompanyNameType filingAirline;
    @XmlElement(name = "MarketingAirline", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "DiscountPricing", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected FareInfoType.DiscountPricing discountPricing;
    @XmlElement(name = "City", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class FareInfo {
        ...
        @XmlElement(name = "Fare", namespace = "http://www.opentravel.org/OTA/2003/05")
        protected FareInfoType.FareInfo.Fare fare;
        @XmlElement(name = "PTC", namespace = "http://www.opentravel.org/OTA/2003/05")
