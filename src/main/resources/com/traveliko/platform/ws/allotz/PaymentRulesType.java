...
@XmlType(name = "PaymentRulesType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "paymentRule"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.RateRulesType.PaymentRules.class
})
