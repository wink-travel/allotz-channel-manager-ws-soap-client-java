...
@XmlType(name = "CompanyNameType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "value"
})
@XmlSeeAlso({
    OperatingAirlineType.class,
    com.traveliko.platform.ws.allotz.AllianceConsortiumType.AllianceMember.class,
    com.traveliko.platform.ws.allotz.DirectBillType.CompanyName.class,
    com.traveliko.platform.ws.allotz.VehicleAvailCoreType.Vendor.class,
    CompanyNamePrefType.class,
    com.traveliko.platform.ws.allotz.ContactInfoType.CompanyName.class,
    TravelArrangerType.class,
    com.traveliko.platform.ws.allotz.FlightSegmentType.MarketingAirline.class
})
