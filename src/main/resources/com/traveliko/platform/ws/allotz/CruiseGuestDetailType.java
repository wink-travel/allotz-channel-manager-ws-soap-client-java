...
@XmlType(name = "CruiseGuestDetailType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "selectedFareCode",
    "contactInfo",
    "guestTransportation",
    "loyaltyInfo",
...
public class CruiseGuestDetailType {
    ...
    @XmlElement(name = "SelectedFareCode", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    @XmlElement(name = "GuestTransportation", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<GuestTransportationType> guestTransportation;
    @XmlElement(name = "LoyaltyInfo", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<CruiseGuestDetailType.LoyaltyInfo> loyaltyInfo;
    @XmlElement(name = "LinkedTraveler", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<CruiseGuestDetailType.LinkedTraveler> linkedTraveler;
    @XmlElement(name = "TravelDocument", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<DocumentType> travelDocument;
    @XmlElement(name = "SelectedDining", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<CruiseGuestDetailType.SelectedDining> selectedDining;
    @XmlElement(name = "SelectedInsurance", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<CruiseGuestDetailType.SelectedInsurance> selectedInsurance;
    @XmlElement(name = "SelectedOptions", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected List<AmenityOptionType> selectedOptions;
    @XmlElement(name = "SelectedPackages", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected CruiseGuestDetailType.SelectedPackages selectedPackages;
    @XmlElement(name = "SelectedSpecialServices", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected CruiseGuestDetailType.SelectedSpecialServices selectedSpecialServices;
    @XmlElement(name = "AirAccommodations", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected CruiseGuestDetailType.AirAccommodations airAccommodations;
    @XmlElement(name = "CruiseDocument", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class AirAccommodations {
        ...
        @XmlElement(name = "AirAccommodation", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class SelectedPackages {
        ...
        @XmlElement(name = "SelectedPackage", namespace = "http://www.opentravel.org/OTA/2003/05")
            ...
            extends CruisePackageType
        {
            ...
            @XmlElement(name = "AirInfo", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class SelectedSpecialServices {
        ...
        @XmlElement(name = "SelectedSpecialService", namespace = "http://www.opentravel.org/OTA/2003/05")
