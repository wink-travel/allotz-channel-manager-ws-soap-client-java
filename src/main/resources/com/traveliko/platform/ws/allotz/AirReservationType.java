...
@XmlType(name = "AirReservationType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "airItinerary",
    "priceInfo",
    "travelerInfo",
    "fulfillment",
...
public class AirReservationType {
    ...
    @XmlElement(name = "Ticketing", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class PricingOverview {
        ...
        @XmlElement(name = "PricingIndicator", namespace = "http://www.opentravel.org/OTA/2003/05")
