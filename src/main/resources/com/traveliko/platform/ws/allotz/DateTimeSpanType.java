...
@XmlType(name = "DateTimeSpanType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "dateWindowRange",
    "startDateWindow",
    "endDateWindow"
})
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.ResCommonDetailType.TimeSpan.class
})
