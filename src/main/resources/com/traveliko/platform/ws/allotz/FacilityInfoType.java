...
@XmlType(name = "FacilityInfoType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "meetingRooms",
    "guestRooms",
    "restaurants"
})
public class FacilityInfoType {
    ...
    @XmlElement(name = "MeetingRooms", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected FacilityInfoType.MeetingRooms meetingRooms;
    @XmlElement(name = "GuestRooms", namespace = "http://www.opentravel.org/OTA/2003/05")
    protected FacilityInfoType.GuestRooms guestRooms;
    @XmlElement(name = "Restaurants", namespace = "http://www.opentravel.org/OTA/2003/05")
    ...
    public static class GuestRooms {
        ...
        @XmlElement(name = "GuestRoom", namespace = "http://www.opentravel.org/OTA/2003/05")
        ...
        public static class GuestRoom {
            ...
            @XmlElement(name = "TypeRoom", namespace = "http://www.opentravel.org/OTA/2003/05")
            protected List<FacilityInfoType.GuestRooms.GuestRoom.TypeRoom> typeRoom;
            @XmlElement(name = "Amenities", namespace = "http://www.opentravel.org/OTA/2003/05")
        ...
        extends MeetingRoomsType
    {
        ...
        @XmlElement(name = "Codes", namespace = "http://www.opentravel.org/OTA/2003/05")
        ...
        public static class Codes {
            ...
            @XmlElement(name = "Code", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
