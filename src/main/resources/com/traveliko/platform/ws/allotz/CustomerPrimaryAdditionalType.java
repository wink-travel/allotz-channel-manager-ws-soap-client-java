...
@XmlType(name = "CustomerPrimaryAdditionalType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "primary",
    "additional"
})
public class CustomerPrimaryAdditionalType {

    @XmlElement(name = "Primary", namespace = "http://www.opentravel.org/OTA/2003/05", required = true)
    protected CustomerPrimaryAdditionalType.Primary primary;
    @XmlElement(name = "Additional", namespace = "http://www.opentravel.org/OTA/2003/05")
        ...
        extends CustomerType
    {
        ...
        @XmlElement(name = "CustomerID", namespace = "http://www.opentravel.org/OTA/2003/05")
