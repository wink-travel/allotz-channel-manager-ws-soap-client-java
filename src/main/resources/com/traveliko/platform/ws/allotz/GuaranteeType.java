...
@XmlType(name = "GuaranteeType", namespace = "http://www.opentravel.org/OTA/2003/05", propOrder = {
    "guaranteesAccepted",
    "deadline",
    "comments",
...
@XmlSeeAlso({
    com.traveliko.platform.ws.allotz.BookingRulesType.BookingRule.AcceptableGuarantees.AcceptableGuarantee.class
})
public class GuaranteeType {
    ...
    @XmlElement(name = "GuaranteeDescription", namespace = "http://www.opentravel.org/OTA/2003/05")
